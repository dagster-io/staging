...
import {
  ...
  TriggerGraphsRunFragment_stepStats
} from "./types/TriggerGraphsRunFragment";
...
type StepStat = TriggerGraphsRunFragment_stepStats;
...
const getStepDurationsForRun = (run: any) => {
  ...
  stepStats.forEach((stepStat: StepStat) => {
