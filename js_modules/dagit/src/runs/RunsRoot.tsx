...
import {AllUpcomingTicks, UPCOMING_TICKS_FRAGMENT} from 'src/runs/AllUpcomingTicks';
          ...
          <Loading queryResult={queryResult} allowStaleData={true}>
            {({pipelineRunsOrError, repositoriesOrError}) => {
              ...
              if (showScheduled) {
                return (
                  <Box margin={{top: 4}}>
                    <AllUpcomingTicks repos={repositoriesOrError} />
                  </Box>
                );
              }
...
const RUNS_ROOT_QUERY = gql`
  query RunsRootQuery(
    ...
    repositoriesOrError {
      ...UpcomingTicksFragment
    }
  }

  ${RunTable.fragments.RunTableRunFragment}
  ${COUNT_FRAGMENT}
  ${UPCOMING_TICKS_FRAGMENT}
`;
