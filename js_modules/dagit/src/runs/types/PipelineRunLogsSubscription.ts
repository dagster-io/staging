...
export interface PipelineRunLogsSubscription_pipelineRunLogs_PipelineRunLogsSubscriptionSuccess_messages_AssetStoreOperationEvent_assetStoreResult {
  __typename: "AssetStoreOperationResult";
  op: AssetStoreOperationType;
}

export interface PipelineRunLogsSubscription_pipelineRunLogs_PipelineRunLogsSubscriptionSuccess_messages_AssetStoreOperationEvent {
  ...
  level: LogLevel;
  stepKey: string | null;
  assetStoreResult: PipelineRunLogsSubscription_pipelineRunLogs_PipelineRunLogsSubscriptionSuccess_messages_AssetStoreOperationEvent_assetStoreResult;
}
