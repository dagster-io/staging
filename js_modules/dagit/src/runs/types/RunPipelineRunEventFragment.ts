...
export interface RunPipelineRunEventFragment_StepMaterializationEvent_materialization_metadataEntries_EventAddressMetadataEntry {
...
export interface RunPipelineRunEventFragment_ExecutionStepFailureEvent_failureMetadata_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
...
export interface RunPipelineRunEventFragment_ExecutionStepInputEvent_typeCheck_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
...
export interface RunPipelineRunEventFragment_ExecutionStepOutputEvent_typeCheck_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
...
export interface RunPipelineRunEventFragment_StepExpectationResultEvent_expectationResult_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
...
export interface RunPipelineRunEventFragment_ObjectStoreOperationEvent_operationResult_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
...
export interface RunPipelineRunEventFragment_EngineEvent_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
