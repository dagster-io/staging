...
import {LegendColumn, RowColumn} from 'src/ListComponents';
    ...
    <div>
      <RunTable
        ...
        additionalColumnHeaders={[
          <LegendColumn key="context" style={{maxWidth: 150}}>
            Step Info
          </LegendColumn>,
        ]}
...
const StepStatsColumn: React.FunctionComponent<{
  ...
  return (
    <RowColumn key="context" style={{maxWidth: 150, borderRight: 0}}>
      {stats ? (
        <div>
          <StatSummaryLine>
            <div
