...
import { Checkbox, Divider, Intent, NonIdealState, ProgressBar, Icon } from "@blueprintjs/core";
...
export const PartitionsBackfillPartitionSelector: React.FunctionComponent<{
  ...
  const { partitionSetOrError, pipelineSnapshotOrError } = data;
  ...
  const pipelineSnapshot = pipelineSnapshotOrError;
