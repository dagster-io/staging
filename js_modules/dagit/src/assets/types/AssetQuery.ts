...
export interface AssetQuery_assetOrError_Asset_graphMaterializations_materializationEvent_materialization_metadataEntries_EventAddressMetadataEntry {
...
export interface AssetQuery_assetOrError_Asset_lastMaterializations_materializationEvent_materialization_metadataEntries_EventAddressMetadataEntry {
  __typename: "EventAddressMetadataEntry";
  label: string;
  description: string | null;
  address: string | null;
