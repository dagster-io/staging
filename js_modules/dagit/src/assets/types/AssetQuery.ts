...
export interface AssetQuery_assetOrError_Asset_assetMaterializations_materializationEvent_parentAssetRelations_assetKey {
  __typename: "AssetKey";
  path: string[];
}

export interface AssetQuery_assetOrError_Asset_assetMaterializations_materializationEvent_parentAssetRelations {
  __typename: "AssetRelation";
  assetKey: AssetQuery_assetOrError_Asset_assetMaterializations_materializationEvent_parentAssetRelations_assetKey;
  partitions: string[];
}
...
export interface AssetQuery_assetOrError_Asset_assetMaterializations_materializationEvent {
  ...
  parentAssetRelations: AssetQuery_assetOrError_Asset_assetMaterializations_materializationEvent_parentAssetRelations[];
}
