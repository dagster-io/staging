      ...
      <Table striped style={{width: '100%'}}>
        ...
        <tbody>
          {schedules.map((schedule) => (
            <ScheduleRow repoAddress={repoAddress} schedule={schedule} key={schedule.originId} />
          ))}
        </tbody>
      </Table>{' '}
    </>
  ...
  return (
    <Callout style={{marginBottom: 20}} intent={Intent.WARNING}>
      <div style={{display: 'flex', justifyContent: 'space-between'}}>
        <h4 style={{margin: 0}}>
          Note: You can turn off any of following schedules, but you cannot turn them back on.{' '}
        </h4>
