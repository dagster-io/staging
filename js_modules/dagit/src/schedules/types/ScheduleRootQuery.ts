...
export interface ScheduleRootQuery_scheduleOrError_Schedule_scheduleState_lastRequestedRuns {
...
export interface ScheduleRootQuery_scheduleOrError_Schedule_scheduleState {
  ...
  lastRequestedRuns: ScheduleRootQuery_scheduleOrError_Schedule_scheduleState_lastRequestedRuns[];
