...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors_futureTick {
  __typename: "FutureJobTick";
  timestamp: number;
}
...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors {
  ...
  solidSelection: (string | null)[] | null;
  mode: string;
  futureTick: InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors_futureTick | null;
