...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_scheduleState_lastRequestedRuns {
...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_scheduleState {
  ...
  lastRequestedRuns: InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_scheduleState_lastRequestedRuns[];
...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors_sensorState_lastRequestedRuns {
  __typename: "PipelineRun";
  id: string;
  runId: string;
  status: PipelineRunStatus;
...
export interface InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors_sensorState {
  ...
  lastRequestedRuns: InstanceJobsRootQuery_repositoriesOrError_RepositoryConnection_nodes_sensors_sensorState_lastRequestedRuns[];
...
export interface InstanceJobsRootQuery_unloadableJobStatesOrError_JobStates_results_lastRequestedRuns {
  __typename: "PipelineRun";
  id: string;
  runId: string;
  status: PipelineRunStatus;
...
export interface InstanceJobsRootQuery_unloadableJobStatesOrError_JobStates_results {
  ...
  lastRequestedRuns: InstanceJobsRootQuery_unloadableJobStatesOrError_JobStates_results_lastRequestedRuns[];
