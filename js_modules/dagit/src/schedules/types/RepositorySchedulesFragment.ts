...
export interface RepositorySchedulesFragment_schedules_scheduleState_lastRequestedRuns {
...
export interface RepositorySchedulesFragment_schedules_scheduleState {
  ...
  lastRequestedRuns: RepositorySchedulesFragment_schedules_scheduleState_lastRequestedRuns[];
