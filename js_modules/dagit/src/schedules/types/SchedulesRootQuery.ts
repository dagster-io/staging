...
export interface SchedulesRootQuery_repositoryOrError_Repository_repositoryMetadata {
  __typename: "RepositoryMetadata";
  key: string;
  value: string;
}
...
export interface SchedulesRootQuery_repositoryOrError_Repository {
  ...
  repositoryMetadata: SchedulesRootQuery_repositoryOrError_Repository_repositoryMetadata[];
}
