...
export interface SensorRootQuery_sensorOrError_Sensor_sensorState_lastRequestedRuns {
...
export interface SensorRootQuery_sensorOrError_Sensor_sensorState {
  ...
  lastRequestedRuns: SensorRootQuery_sensorOrError_Sensor_sensorState_lastRequestedRuns[];
