...
export interface ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_runConfigOrError_RunConfig {
...
export type ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_runConfigOrError = ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_runConfigOrError_RunConfig | ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_runConfigOrError_PythonError;

export interface ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError_TagsList_results {
  __typename: "PipelineTag";
  key: string;
  value: string;
}

export interface ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError_TagsList {
  __typename: "TagsList";
  results: ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError_TagsList_results[];
}
...
export type ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError = ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError_TagsList | ConfigPartitionSelectionQuery_partitionSetOrError_PartitionSet_partition_tagsOrError_PythonError;
