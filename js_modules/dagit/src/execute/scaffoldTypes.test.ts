...
const allConfigTypes: ConfigEditorRunConfigSchemaFragment_allConfigTypes[] = [
  ...
  {
    __typename: 'NullableConfigType',
    key: 'Noneable.Shape.edaf58ebbb1501016391c8d9f0ae1a054053279e',
    description: null,
    isSelector: false,
    typeParamKeys: ['Shape.edaf58ebbb1501016391c8d9f0ae1a054053279e'],
  },
  {
    __typename: 'NullableConfigType',
    key: 'Noneable.String',
  ...
  },
  {
    ...
    key: 'Permissive.adb69eb5b4b22eb43c3732584a5669bfdf273a3a',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      {
        ...
        name: 'inner_shape_array',
        description: null,
        isRequired: true,
        configTypeKey: 'Array.String',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'inner_shape_string',
        description: null,
        isRequired: true,
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Selector.b44d6b5f1205a535d99782cde06b346523e7053e',
    description: null,
    isSelector: true,
    typeParamKeys: [],
    fields: [
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.11a73228c07f70bbd2b708339f24b1ab7c06611f',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.96753c504e047d4bc20f3c60c84bf06b005d3071',
      },
    ],
  },
  {
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.28c00ca0a19c9fd1e9dd5ec4c76e9118d7b91838',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      ...
      },
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.adb69eb5b4b22eb43c3732584a5669bfdf273a3a',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'default_value',
      ...
      },
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Noneable.Array.String',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'noneable_complex_shape',
        description: null,
        isRequired: true,
        configTypeKey: 'Noneable.Shape.edaf58ebbb1501016391c8d9f0ae1a054053279e',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'noneable_string',
        description: null,
        isRequired: true,
        configTypeKey: 'Noneable.String',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'not_required',
      ...
      {
        __typename: 'ConfigTypeField',
        name: 'permissive_complex_shape',
        description: null,
        isRequired: true,
        configTypeKey: 'Permissive.adb69eb5b4b22eb43c3732584a5669bfdf273a3a',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'selector',
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.5454c3b1fd84b545fb4c2617ef38784b98a495b6',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.11a73228c07f70bbd2b708339f24b1ab7c06611f',
      },
    ],
  },
  {
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.96753c504e047d4bc20f3c60c84bf06b005d3071',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.9dd706199500dc5eb46bcfa007518b12c08abce4',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      ...
      },
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.5454c3b1fd84b545fb4c2617ef38784b98a495b6',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'solids',
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.dc6d9412bb1e0db9c03d948a9d0572183e57336b',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'storage',
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.adb69eb5b4b22eb43c3732584a5669bfdf273a3a',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.b4c679db15f897a8888d0bd7e4879f1566fa3bc5',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.dc6d9412bb1e0db9c03d948a9d0572183e57336b',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      {
        ...
        description: null,
        isRequired: true,
        configTypeKey: 'Shape.b4c679db15f897a8888d0bd7e4879f1566fa3bc5',
      },
    ],
  },
  {
  ...
  {
    __typename: 'CompositeConfigType',
    key: 'Shape.edaf58ebbb1501016391c8d9f0ae1a054053279e',
    description: null,
    isSelector: false,
    typeParamKeys: [],
    fields: [
      {
        __typename: 'ConfigTypeField',
        name: 'inner_noneable_shape_array',
        description: null,
        isRequired: true,
        configTypeKey: 'Array.String',
      },
      {
        __typename: 'ConfigTypeField',
        name: 'inner_noneable_shape_string',
        description: null,
        isRequired: true,
        configTypeKey: 'String',
      },
  ...
  },
  {
    ...
    description: null,
    isSelector: false,
    typeParamKeys: ['String', 'Selector.2571019f1a5201853d11032145ac3e534067f214'],
    scalarTypeKey: 'String',
    nonScalarTypeKey: 'Selector.2571019f1a5201853d11032145ac3e534067f214',
  },
];
...
describe('scaffoldType', () => {
  ...
  it('scaffoldType recursive descent', () => {
    expect(scaffoldType('Shape.9dd706199500dc5eb46bcfa007518b12c08abce4', typeLookup)).toEqual({
      resources: {
        my_resource: {
          config: {
            array: [],
