...
const TickHistoryGraph: React.FC<{
  ...
  selectedTab: string;
  maxBounds?: Bounds;
}> = ({ticks, selectedTick, onSelectTick, onHighlightRunIds, selectedTab, maxBounds}) => {
...
const JOB_TICK_HISTORY_QUERY = gql`
  query JobTickHistoryQuery($jobSelector: JobSelector!, $dayRange: Int) {
