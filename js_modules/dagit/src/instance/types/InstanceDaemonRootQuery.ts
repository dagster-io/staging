...
export interface InstanceDaemonRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_partitionSet_partitionStatuses {
...
export interface InstanceDaemonRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_partitionSet {
  ...
  name: string;
  partitionStatuses: InstanceDaemonRootQuery_repositoriesOrError_RepositoryConnection_nodes_schedules_partitionSet_partitionStatuses[];
}
