...
export interface InstanceBackfillsQuery_partitionBackfillsOrError_PartitionBackfills_results_partitionSetOrigin_repoAddress {
  __typename: "RepoAddress";
  name: string;
  location: string;
}

export interface InstanceBackfillsQuery_partitionBackfillsOrError_PartitionBackfills_results_partitionSetOrigin {
  __typename: "PartitionSetOrigin";
  partitionSetName: string;
  repoAddress: InstanceBackfillsQuery_partitionBackfillsOrError_PartitionBackfills_results_partitionSetOrigin_repoAddress;
}
...
export interface InstanceBackfillsQuery_partitionBackfillsOrError_PartitionBackfills_results {
  ...
  partitionSetOrigin: InstanceBackfillsQuery_partitionBackfillsOrError_PartitionBackfills_results_partitionSetOrigin | null;
