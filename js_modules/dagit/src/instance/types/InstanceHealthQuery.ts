...
export interface InstanceHealthQuery_repositoriesOrError_RepositoryConnection_nodes_repositoryMetadata {
...
export interface InstanceHealthQuery_repositoriesOrError_RepositoryConnection_nodes {
  ...
  repositoryMetadata: InstanceHealthQuery_repositoriesOrError_RepositoryConnection_nodes_repositoryMetadata[];
