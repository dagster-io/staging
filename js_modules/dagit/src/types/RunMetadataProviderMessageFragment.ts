...
export interface RunMetadataProviderMessageFragment_StepMaterializationEvent_materialization_metadataEntries_EventHtmlMetadataEntry {
...
export interface RunMetadataProviderMessageFragment_StepExpectationResultEvent_expectationResult_metadataEntries_EventHtmlMetadataEntry {
  __typename: "EventHtmlMetadataEntry";
  label: string;
  description: string | null;
  html: string;
...
export interface RunMetadataProviderMessageFragment_ObjectStoreOperationEvent_operationResult_metadataEntries_EventHtmlMetadataEntry {
  __typename: "EventHtmlMetadataEntry";
  label: string;
  description: string | null;
  html: string;
