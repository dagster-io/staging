...
export interface InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData_SensorData {
  __typename: "SensorData";
  lastRunKey: string | null;
}

export interface InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData_ScheduleData {
  __typename: "ScheduleData";
  cronSchedule: string;
}

export type InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData = InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData_SensorData | InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData_ScheduleData;
...
export interface InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results {
  ...
  typeSpecificData: InstanceSensorsQuery_unloadableJobStatesOrError_InstigationStates_results_typeSpecificData | null;
