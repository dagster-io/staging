...
export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_displayMetadata {
  __typename: "RepositoryMetadata";
  key: string;
  value: string;
}

export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation {
...
export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_PythonError {
  __typename: "PythonError";
  message: string;
}

export type InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError = InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation | InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_PythonError;

export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes {
  __typename: "WorkspaceLocationEntry";
  id: string;
  name: string;
  loadStatus: RepositoryLocationLoadStatus;
  displayMetadata: InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_displayMetadata[];
  updatedTimestamp: number;
  locationOrLoadError: InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError | null;
}

export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection {
  __typename: "WorkspaceConnection";
  nodes: InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes[];
}
...
export type InstanceSensorsQuery_workspaceOrError = InstanceSensorsQuery_workspaceOrError_WorkspaceConnection | InstanceSensorsQuery_workspaceOrError_PythonError;
