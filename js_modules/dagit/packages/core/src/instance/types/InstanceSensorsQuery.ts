...
export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_location {
...
export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_loadError {
  __typename: "PythonError";
  message: string;
}
...
export interface InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes {
  ...
  location: InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_location | null;
  loadError: InstanceSensorsQuery_workspaceOrError_WorkspaceConnection_nodes_loadError | null;
}
