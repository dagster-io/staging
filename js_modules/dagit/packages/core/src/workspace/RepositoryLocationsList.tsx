...
import {RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_locationEntries as LocationOrError} from './types/RootRepositoriesQuery';
...
const LocationStatus: React.FC<{locationOrError: LocationOrError}> = (props) => {
  ...
  if (locationOrError.loadStatus === 'LOADING') {
    if (locationOrError.location || locationOrError.loadError) {
      return (
      ...
      <>
        ...
        >
          <div className={Classes.DIALOG_BODY}>
            ...
            <PythonErrorInfo error={locationOrError.loadError} />
          </div>
