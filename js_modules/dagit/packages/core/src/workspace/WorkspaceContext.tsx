...
import {
  ...
  RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_location,
  RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_location_repositories,
} from './types/RootRepositoriesQuery';

type Repository = RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_location_repositories;
type RepositoryLocation = RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_location;
...
const useWorkspaceState = () => {
  ...
  const {options, error} = React.useMemo(() => {
    ...
    options = data.workspaceOrError.nodes.reduce((accum, locationEntry) => {
      ...
      const repositoryLocation = locationEntry.location;
