...
import {
  ...
  RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes,
  RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation,
  RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation_repositories,
} from './types/RootRepositoriesQuery';

type Repository = RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation_repositories;
type RepositoryLocation = RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation;
type RepositoryLocationNode = RootRepositoriesQuery_workspaceOrError_WorkspaceConnection_nodes;
...
const useWorkspaceState = () => {
  ...
  const nodes = React.useMemo(() => {
    return data?.workspaceOrError.__typename === 'WorkspaceConnection'
      ? data?.workspaceOrError.nodes
      : [];
  }, [data]);
  ...
  const {options, error} = React.useMemo(() => {
    ...
    options = data.workspaceOrError.nodes.reduce((accum, locationEntry) => {
