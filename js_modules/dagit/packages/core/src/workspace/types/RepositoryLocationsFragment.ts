...
export interface RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation {
...
export interface RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError_PythonError {
  __typename: "PythonError";
  message: string;
}

export type RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError = RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError_RepositoryLocation | RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError_PythonError;
...
export interface RepositoryLocationsFragment_WorkspaceConnection_nodes {
  ...
  locationOrLoadError: RepositoryLocationsFragment_WorkspaceConnection_nodes_locationOrLoadError | null;
}
