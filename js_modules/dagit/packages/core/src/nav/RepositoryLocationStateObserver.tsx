...
export const RepositoryLocationStateObserver = ({client}: StateObserverProps) => {
  const {nodes, refetch} = React.useContext(WorkspaceContext);
      ...
      switch (eventType) {
        ...
        case LocationStateChangeEventType.LOCATION_UPDATED:
          ...
          if (
            ...
            matchingRepositoryLocation.location &&
            matchingRepositoryLocation.location.serverId !== serverId
          ) {
