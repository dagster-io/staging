...
from dagster.instigator.default_run_dequeuer import IN_PROGRESS_STATUSES, DefaultRunDequeuer
...
def test_attempt_to_launch_runs_filter(instance):  # pylint: disable=redefined-outer-name
    ...
    dequeuer = DefaultRunDequeuer(instance)
...
def test_get_queued_runs_max_runs(
    ...
    dequeuer = DefaultRunDequeuer(instance, max_concurrent_runs=max_runs)
    dequeuer.attempt_to_launch_runs()
