...
def test_0_10_8_pre_asset_tags():
    src_dir = file_relative_path(__file__, "snapshot_0_10_8_pre_asset_tags/sqlite")
    with copy_directory(src_dir) as test_dir:
        ...
        with DagsterInstance.from_ref(InstanceRef.from_dir(test_dir)) as instance:
            instance.upgrade()
            assert "asset_tags" in get_sqlite3_tables(db_path)
