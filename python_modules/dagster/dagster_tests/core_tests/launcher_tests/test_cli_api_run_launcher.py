...
def test_terminated_run():
    with instance_for_test() as instance:
        ...
        expected_termination_events = [
            ...
            "Pipeline was terminated successfully.",
            "Received pipeline termination request.",
            "Pipeline was not terminated since process is not alive.",
        ]
        ...
        # The second termination request may or may not log events before we fetch all logs
