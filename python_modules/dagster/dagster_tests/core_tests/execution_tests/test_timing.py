...
def test_event_timing_before_yield():
    ...
    pipeline_def = PipelineDefinition(name="test", solid_defs=[before_yield_solid])
...
def test_event_timing_after_yield():
    ...
    pipeline_def = PipelineDefinition(name="test", solid_defs=[after_yield_solid])
    pipeline_result = execute_pipeline(pipeline_def)
...
def test_event_timing_direct_return():
    ...
    pipeline_def = PipelineDefinition(name="test", solid_defs=[direct_return_solid])
    pipeline_result = execute_pipeline(pipeline_def)
