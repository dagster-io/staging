...
from dagster.core.execution.context_creation_pipeline import PlanOrchestrationContextManager
...
def test_clean_event_generator_exit():
    ...
    generator = PlanOrchestrationContextManager(  # pylint: disable=protected-access
