...
def test_single_solid_pipeline_composite_descent():
    ...
    solid_config_dict = composite_descent(
        return_int_pipeline,
        {"return_int": {"config": 3}},
        resource_defs={"object_manager": mem_io_manager},
    )
...
def test_single_layer_pipeline_hardcoded_config_mapping():
    ...
    solid_config_dict = composite_descent(
        return_int_hardcode_wrap_pipeline, {}, resource_defs={"object_manager": mem_io_manager}
    )
...
def test_nested_input_via_config_mapping():
    ...
    solid_config_dict = composite_descent(
        wrap_add_one_pipeline, {}, resource_defs={"object_manager": mem_io_manager}
    )
