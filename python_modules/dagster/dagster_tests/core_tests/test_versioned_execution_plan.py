...
def test_resolve_versions_no_external_dependencies():
    instance = DagsterInstance.ephemeral()
    versions = instance.resolve_versions(versioned_pipeline)
...
def test_resolve_versions_external_dependencies():
    instance = DagsterInstance.ephemeral()
    versions = instance.resolve_versions(
