...
def test_mode_no_parens_decorator_takes_a_name():
    @mode
    def a_mode():
        return {}
...
def test_mode_parens_with_args_decorator_takes_a_name():
    @mode(intermediate_storage_defs=[])
    def a_mode():
        return {}

    assert a_mode.name == "a_mode"
