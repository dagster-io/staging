...
def check_materialization(materialization, asset_key, parent_assets=[], metadata_entries=[]):
    event_data = materialization.event_specific_data
    assert event_data.materialization.asset_key == asset_key
    assert event_data.materialization.metadata_entries == metadata_entries
    assert event_data.parent_assets == parent_assets
