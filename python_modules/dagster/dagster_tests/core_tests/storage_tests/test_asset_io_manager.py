...
def test_asset_io_manager():
    metadata_entry1 = EventMetadataEntry.text("fdsjk", label="my_label")
    metadata_entry2 = EventMetadataEntry.text("fdsfdsjk", label="my_other_label")
    ...
    def solid1(_):
        yield Output(5, "output1", metadata_entries=[metadata_entry2])
    ...
    assert materialization1.metadata_entries == [metadata_entry1, metadata_entry2]


def test_asset_io_manager_multiple_partitions():
    pass
