...
from dagster.core.storage.asset_store import AssetStoreHandle, custom_path_filesystem_asset_store
...
def test_address_storage():
    with seven.TemporaryDirectory() as tmpdir_path:
        test_asset_store = custom_path_filesystem_asset_store
        ...
        assert asset_address_a.asset_metadata["path"] == test_asset_metadata_dict["solid_a"]["path"]
        ...
        assert asset_address_b.asset_metadata["path"] == test_asset_metadata_dict["solid_b"]["path"]
