...
def test_type_materializer_and_configurable_output_manager():
    ...
    @solid(
        output_defs=[
            OutputDefinition(name="output1", io_manager_key="my_output_manager", dagster_type=my_type),
...
def test_output_manager_no_input_manager():
    ...
    @solid(output_defs=[OutputDefinition(name="output_alone", io_manager_key="output_manager_alone")])
    def emit_str(_):
        raise NotImplementedError()
