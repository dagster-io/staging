    ...
    with event_storage_factory_cm_fn() as storage:
        ...
        storage.store_event(
            DagsterEventRecord(
                ...
                "",
                enqueued_time,
                dagster_event=DagsterEvent(DagsterEventType.PIPELINE_ENQUEUED.value, "",),
            )
        )
        storage.store_event(
            DagsterEventRecord(
                ...
                "",
                launched_time,
                dagster_event=DagsterEvent(DagsterEventType.PIPELINE_STARTING.value, "",),
            )
        )
        storage.store_event(
            DagsterEventRecord(
                ...
                "",
                start_time,
                dagster_event=DagsterEvent(DagsterEventType.PIPELINE_START.value, "",),
            )
        )
