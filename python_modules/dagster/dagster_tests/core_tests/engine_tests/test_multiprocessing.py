...
def test_crash_multiprocessing():
    ...
    # The argument to sys.exit won't make it to the compute logs for stderr b/c the LocalComputeLogManger is
    # in-process -- documenting this behavior here though we may want to change it
...
def test_crash_hard_multiprocessing():
    ...
    # Neither the stderr not the stdout spew will make it to the compute logs -- documenting this
    # behavior here though we may want to change it
