...
class TestStepHandler(StepHandler):
    ...
    def launch_step(self, execute_step_args: ExecuteStepArgs):
    ...
    def check_step_health(self, _execute_step_args: ExecuteStepArgs) -> List[DagsterEvent]:
        return []

    def terminate_step(self, execute_step_args: ExecuteStepArgs):
