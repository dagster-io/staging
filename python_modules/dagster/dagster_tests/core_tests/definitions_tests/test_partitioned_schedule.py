...
def job_for_partitions(partitioned_config):
    @solid
    def my_solid():
        pass
    ...
    return schedule_from_partitions(
        ...
        time_of_day=partitioned_config.partitions_def.execution_time,
    )


def test_daily_schedule_from_partitions():
    @daily_partitioned_config(start_date="2021-05-05", execution_time=time(hour=9, minute=30))
    ...
    assert my_schedule.evaluate_tick(
        ...
        "start": "2021-05-06T09:30:00+00:00",
        "end": "2021-05-07T09:30:00+00:00",
    }


def test_hourly_schedule_from_partitions():
    @hourly_partitioned_config(start_date="2021-05-05", execution_time=time(minute=30))
    def my_partitioned_config(start, end):
        return {"start": str(start), "end": str(end)}
    ...
    assert my_schedule.evaluate_tick(
        ...
        "start": "2021-05-07T22:30:00+00:00",
        "end": "2021-05-07T23:30:00+00:00",
    }


def test_weekly_schedule_from_partitions():
    @weekly_partitioned_config(
        start_date="2021-05-05", execution_time=time(hour=9, minute=30), execution_day_of_week=2
    )
    def my_partitioned_config(start, end):
        return {"start": str(start), "end": str(end)}
    ...
    assert my_schedule.evaluate_tick(
        ...
        "start": "2021-05-11T09:30:00+00:00",
        "end": "2021-05-18T09:30:00+00:00",
    }


def test_monthly_schedule_from_partitions():
    @monthly_partitioned_config(
        start_date="2021-05-05", execution_time=time(hour=9, minute=30), execution_day_of_month=2
    )
    def my_partitioned_config(start, end):
        return {"start": str(start), "end": str(end)}
    ...
    assert my_schedule.evaluate_tick(
        ...
        "start": "2021-06-02T09:30:00+00:00",
        "end": "2021-07-02T09:30:00+00:00",
    }
