...
def test_basic():
    ...
    assert (
        execute_pipeline(PipelineDefinition(name="test", solid_defs=[test]))
...
def test_multiple():
    ...
    results = execute_pipeline(PipelineDefinition(name="test", solid_defs=[test]))
...
def test_diamond_graph():
    ...
    result = execute_pipeline(PipelineDefinition(name="test", solid_defs=[diamond]))
...
def test_deep_graph():
    ...
    result = execute_pipeline(
        PipelineDefinition(name="test", solid_defs=[test]),
...
def test_recursion():
    ...
    assert execute_pipeline(PipelineDefinition(name="test", solid_defs=[outer])).success
