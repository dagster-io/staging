...
def _is_external_object_event(event):
    ops = (
    ...
    return (
        ...
        and event.event_specific_data.op in ops
    )
...
def test_address_config_value_operation_run_config():
    ...
    with seven.TemporaryDirectory() as tempdir:
        ...
        external_intermediate_events = list(filter(_is_external_object_event, result.event_list))
