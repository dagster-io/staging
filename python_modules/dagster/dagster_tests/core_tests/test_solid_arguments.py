...
def test_solid_input_arguments():
    ...
    assert _no_param._context_arg_provided == False
    ...
    assert _underscore_param._context_arg_provided == True
    ...
    assert _context_param_underscore._context_arg_provided == True
    ...
    assert _context_param_back_underscore._context_arg_provided == True
    ...
    assert _context_param_regular._context_arg_provided == True
    ...
    assert _context_with_inferred_inputs._context_arg_provided == True
    ...
    @solid
    def _context_with_inferred_context_named_inputs(context, _context, context_):
        pass

    assert _context_with_inferred_context_named_inputs._context_arg_provided == True
    assert "_context" in _context_with_inferred_context_named_inputs.input_dict
    assert "context_" in _context_with_inferred_context_named_inputs.input_dict
    assert "context" not in _context_with_inferred_inputs.input_dict
    ...
    assert _context_with_underscore_arg._context_arg_provided == True
    assert "_" in _context_with_underscore_arg.input_dict
    ...
    assert _underscore_after_input_arg._context_arg_provided == False
    ...
    assert _lambda_solid_underscore_input._context_arg_provided == False
