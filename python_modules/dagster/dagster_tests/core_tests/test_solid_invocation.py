...
import pytest
from dagster import Output, pipeline, resource, solid
...
def test_solid_invocation_with_cm_resource():
    ...
    context = get_solid_execution_context(resources={"cm_resource": cm_resource})
    ...
    with get_solid_execution_context(resources={"cm_resource": cm_resource}) as context:
