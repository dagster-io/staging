from dagster import ModeDefinition, default_executors, logger, pipeline, resource
...
def test_mode_snap(snapshot):
    ...
    pipeline_snapshot = PipelineSnapshot.from_pipeline_def(a_pipeline, default_executors)
