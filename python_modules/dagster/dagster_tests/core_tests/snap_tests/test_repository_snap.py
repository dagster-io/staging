...
def test_repository_snap_all_props():
    ...
    external_repo_data = external_repository_data_from_def(noop_repo, default_executors)
...
def test_repository_snap_empty():
    ...
    external_repo_data = external_repository_data_from_def(empty_repo, default_executors)
