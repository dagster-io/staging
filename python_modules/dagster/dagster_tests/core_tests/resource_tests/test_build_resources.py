...
def _attempt_to_access_cm_resource(tore_down):
    @resource
...
def test_context_manager_resource_as_function():
    ...
    # Put test body in separate function to ensure all references to resources object are gone
    _attempt_to_access_cm_resource(tore_down)
