...
from dagster.core.definitions.resource import I_Contains_Generator
...
def test_basic_resource():
    ...
    with build_resources(
        ...
        assert not isinstance(resources, I_Contains_Generator)
...
def test_context_manager_resource():
    ...
    with build_resources({"cm_resource": cm_resource}) as resources:
        assert isinstance(resources, I_Contains_Generator)
