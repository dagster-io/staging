import pytest
from dagster import InitResourceContext, build_resource_init_context, resource
...
def test_build_with_resources():
    ...
    context = build_resource_init_context(resources={"foo": foo, "bar": "bar"})
...
def test_build_with_cm_resource():
    ...
    context = build_resource_init_context(resources={"foo": foo})
