...
from dagster.core.definitions.resource import make_variables_resource
...
def test_variables_resource():
    ...
    @pipeline(
        mode_defs=[
            ModeDefinition(
                resource_defs={
                    "any_variable": make_variables_resource(),
                    "single_variable": make_variables_resource(foo=str),
                    "multi_variables": make_variables_resource(foo=str, bar=int),
                },
            )
        ]
    )
