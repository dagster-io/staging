...
@pytest.mark.parametrize(
    "start, end, delta, fmt, inclusive, timezone, expected_partitions",
    [
        (
        ...
        (
            ...
            True,
            "US/Central",
            ["2019-03-10-01:00CST", "2019-03-10-03:00CDT", "2019-03-10-04:00CDT"],
        ),
        (
...
def test_date_partition_range(start, end, delta, fmt, inclusive, timezone, expected_partitions):
    partition_generator = date_partition_range(
        start, end, delta, fmt, inclusive=inclusive, timezone=timezone
    )
