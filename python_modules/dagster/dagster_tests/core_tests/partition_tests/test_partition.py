...
def assert_expected_partitions(
    generated_partitions: List[Partition], expected_partitions: List[Partition]
):
    assert all(
...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "partition days offset > 1",
        "partition days offset > 1, current time before end",
        "partition days offset > 1, current time after end",
...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "partition months offset > 1",
        "partition months offset > 1, current time before end",
        "partition months offset > 1, current time after end",
...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "partition weeks offset > 1",
        "partition weeks offset > 1, current time before end",
        "partition weeks offset > 1, current time after end",
    ...
    argvalues=[
        ...
        (
            ...
            datetime(year=2021, month=1, day=31, hour=1, minute=20),
            2,
            create_pendulum_time(2021, 1, 25),
