...
@pytest.mark.parametrize(
    ...
    ids=[
        ...
        "daily partitions, with execution time",
        "monthly partitions",
        "monthly partitions, different start/end year",
        "monthly partitions, start/end not at least a month apart",
        "monthly partitions, with execution time",
        "weekly partitions",
        "weekly partitions, with execution time",
    ...
    argvalues=[
        ...
        (
            ...
            None,
            None,
            ["2019-02-28-01:45+0000", "2019-03-01-01:45+0000", "2019-03-02-01:45+0000"],
        ),
        (
            ScheduleType.MONTHLY,
            datetime(year=2020, month=1, day=1),
        ...
        (
            ...
            None,
            None,
            ["2020-12-01-01:45+0000", "2021-01-01-01:45+0000"],
        ),
        (
            ScheduleType.WEEKLY,
            datetime(year=2020, month=1, day=1),
        ...
        (
            ...
            None,
            None,
            ["2020-01-01-01:45+0000", "2020-01-08-01:45+0000", "2020-01-15-01:45+0000"],
        ),
        (
            ScheduleType.HOURLY,
