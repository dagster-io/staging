...
@hourly_schedule(pipeline_name=noop_pipeline.name, start_date=datetime.datetime(2021, 1, 1))
def hourly_noop_schedule():
    return {}


@daily_schedule(pipeline_name=noop_pipeline.name, start_date=datetime.datetime(2021, 1, 1))
def daily_noop_schedule():
    return {}


@weekly_schedule(pipeline_name=noop_pipeline.name, start_date=datetime.datetime(2021, 1, 1))
def weekly_noop_schedule():
    return {}


@monthly_schedule(pipeline_name=noop_pipeline.name, start_date=datetime.datetime(2021, 1, 1))
