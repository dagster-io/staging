...
from dagster.core.definitions.partition import Partition, PartitionsConfig, StaticPartitions
...
def test_partitions():
    ...
    job = my_graph.to_job(
        config=PartitionsConfig(
            ...
            partitions=StaticPartitions([Partition("2020-02-25"), Partition("2020-02-26")]),
        ),
    )
