...
from dagster.core.definitions.job import JobConfig, JobType
...
def simple_sensor(context):
    ...
    return [JobConfig(run_config={}, tags={})]
...
def execution_key_sensor(_context):
    return [JobConfig(run_config={}, tags={}, execution_key="only_once")]
    ...
    with instance_with_sensors(external_repo_context) as (instance, external_repo):
        with pendulum.test(freeze_datetime):
            ...
            validate_tick(
                ...
                None,
                "Error occurred during the execution of job_config_fn for sensor error_sensor",
            )
