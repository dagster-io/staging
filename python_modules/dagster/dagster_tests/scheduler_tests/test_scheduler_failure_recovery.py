...
"""
        ...
        with pendulum.test(frozen_datetime):
            ...
            assert (
                captured.out
                == """2019-02-26 18:05:00 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-02-26 18:05:00 - dagster-daemon - INFO - Launching run for simple_schedule at 2019-02-27 00:00:00+0000
2019-02-26 18:05:00 - dagster-daemon - INFO - Resuming previously interrupted schedule execution
2019-02-26 18:05:00 - dagster-daemon - INFO - Completed scheduled launch of run {run_id} for simple_schedule
""".format(
