    ...
    with instance_with_schedules(external_repo_context) as (instance, external_repo):
        with pendulum.test(freeze_datetime):
            ...
            launch_scheduled_runs(
                instance, get_default_daemon_logger(), pendulum.now("UTC"),
            )
            assert instance.get_runs_count() == 0
            ticks = instance.get_schedule_ticks(schedule_origin.get_id())
            assert len(ticks) == 0
            ...
            assert (
                captured.out
                == """2019-02-27 17:59:59 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-02-27 17:59:59 - dagster-daemon - INFO - No new runs for simple_schedule
"""
            )
        ...
        with pendulum.test(freeze_datetime):
            ...
            assert (
                captured.out
                == """2019-02-27 18:00:01 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-02-27 18:00:01 - dagster-daemon - INFO - Launching run for simple_schedule at 2019-02-28 00:00:00+0000
2019-02-27 18:00:01 - dagster-daemon - INFO - Completed scheduled launch of run {run_id} for simple_schedule
""".format(
        ...
        with pendulum.test(freeze_datetime):
            ...
            assert (
                captured.out
                == """2019-03-01 18:00:03 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-03-01 18:00:03 - dagster-daemon - INFO - Launching 2 runs for simple_schedule at the following times: 2019-03-01 00:00:00+0000, 2019-03-02 00:00:00+0000
2019-03-01 18:00:03 - dagster-daemon - INFO - Completed scheduled launch of run {first_run_id} for simple_schedule
2019-03-01 18:00:03 - dagster-daemon - INFO - Completed scheduled launch of run {second_run_id} for simple_schedule
""".format(
            ...
            launch_scheduled_runs(instance, get_default_daemon_logger(), pendulum.now("UTC"))
            assert instance.get_runs_count() == 3
            ticks = instance.get_schedule_ticks(schedule_origin.get_id())
            assert len(ticks) == 3
...
def test_skip(external_repo_context, capfd):
    with instance_with_schedules(external_repo_context) as (instance, external_repo):
        ...
        with pendulum.test(initial_datetime):
            ...
            assert (
                captured.out
                == """2019-02-26 18:00:00 - dagster-daemon - INFO - Checking for new runs for the following schedules: skip_schedule
2019-02-26 18:00:00 - dagster-daemon - INFO - Launching run for skip_schedule at 2019-02-27 00:00:00+0000
2019-02-26 18:00:00 - dagster-daemon - INFO - should_execute returned False for skip_schedule, skipping
"""
            )
...
def test_bad_schedules_mixed_with_good_schedule(external_repo_context, capfd):
    with instance_with_schedules(external_repo_context) as (instance, external_repo):
        ...
        with pendulum.test(initial_datetime):
            ...
            launch_scheduled_runs(instance, get_default_daemon_logger(), new_now)
...
def test_multiple_schedules_on_different_time_ranges(external_repo_context, capfd):
    with instance_with_schedules(external_repo_context) as (instance, external_repo):
        ...
        with pendulum.test(initial_datetime):
            ...
            assert (
                captured.out
                == """2019-02-27 18:00:01 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_hourly_schedule, simple_schedule
2019-02-27 18:00:01 - dagster-daemon - INFO - Launching run for simple_hourly_schedule at 2019-02-28 00:00:00+0000
2019-02-27 18:00:01 - dagster-daemon - INFO - Completed scheduled launch of run {first_run_id} for simple_hourly_schedule
2019-02-27 18:00:01 - dagster-daemon - INFO - Launching run for simple_schedule at 2019-02-28 00:00:00+0000
2019-02-27 18:00:01 - dagster-daemon - INFO - Completed scheduled launch of run {second_run_id} for simple_schedule
""".format(
                    first_run_id=instance.get_runs()[1].run_id,
                    second_run_id=instance.get_runs()[0].run_id,
                )
        ...
        with pendulum.test(initial_datetime):
            ...
            assert (
                captured.out
                == """2019-02-27 19:00:01 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_hourly_schedule, simple_schedule
2019-02-27 19:00:01 - dagster-daemon - INFO - Launching run for simple_hourly_schedule at 2019-02-28 01:00:00+0000
2019-02-27 19:00:01 - dagster-daemon - INFO - Completed scheduled launch of run {third_run_id} for simple_hourly_schedule
2019-02-27 19:00:01 - dagster-daemon - INFO - No new runs for simple_schedule
""".format(
...
def test_launch_failure(external_repo_context, capfd):
    with instance_with_schedules(
        ...
        with pendulum.test(initial_datetime):
            ...
            assert (
                captured.out
                == """2019-02-26 18:00:00 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-02-26 18:00:00 - dagster-daemon - INFO - Launching run for simple_schedule at 2019-02-27 00:00:00+0000
2019-02-26 18:00:00 - dagster-daemon - ERROR - Run {run_id} created successfully but failed to launch.
""".format(
                    run_id=instance.get_runs()[0].run_id
                )
            )
...
def test_max_catchup_runs(capfd):
    ...
    with instance_with_schedules(default_repo) as (instance, external_repo):
        ...
        with pendulum.test(initial_datetime):
            ...
            launch_scheduled_runs(
                instance, get_default_daemon_logger(), pendulum.now("UTC"), max_catchup_runs=2,
            )
            ...
            assert (
                captured.out
                == """2019-03-04 17:59:59 - dagster-daemon - INFO - Checking for new runs for the following schedules: simple_schedule
2019-03-04 17:59:59 - dagster-daemon - WARNING - simple_schedule has fallen behind, only launching 2 runs
2019-03-04 17:59:59 - dagster-daemon - INFO - Launching 2 runs for simple_schedule at the following times: 2019-03-03 00:00:00+0000, 2019-03-04 00:00:00+0000
2019-03-04 17:59:59 - dagster-daemon - INFO - Completed scheduled launch of run {first_run_id} for simple_schedule
2019-03-04 17:59:59 - dagster-daemon - INFO - Completed scheduled launch of run {second_run_id} for simple_schedule
""".format(
                    first_run_id=instance.get_runs()[1].run_id,
                    second_run_id=instance.get_runs()[0].run_id,
                )
