...
def test_non_utc_timezone_run(external_repo_context, capfd):
    ...
    with instance_with_schedules(external_repo_context) as (
        ...
        with pendulum.test(freeze_datetime):
            ...
            assert (
                captured.out
                == """2019-02-27 21:59:59 - dagster-daemon - INFO - Checking for new runs for the following schedules: daily_central_time_schedule
2019-02-27 21:59:59 - dagster-daemon - INFO - No new runs for daily_central_time_schedule
"""
            )
        ...
        with pendulum.test(freeze_datetime):
            ...
            assert (
                captured.out
                == """2019-02-27 22:00:01 - dagster-daemon - INFO - Checking for new runs for the following schedules: daily_central_time_schedule
2019-02-27 22:00:01 - dagster-daemon - INFO - Launching run for daily_central_time_schedule at 2019-02-28 00:00:00-0600
2019-02-27 22:00:01 - dagster-daemon - INFO - Completed scheduled launch of run {run_id} for daily_central_time_schedule
""".format(
