...
from dagster.cli.pipeline import execute_print_versions_command
...
class Capturing(list):
    def __enter__(self):
        ...
        self._stringio = StringIO()  # pylint: disable=W0201
...
def test_execute_display_command():
    with seven.TemporaryDirectory() as temp_dir:
        ...
        with Capturing() as output:
            execute_print_versions_command(kwargs=kwargs, instance=instance)
