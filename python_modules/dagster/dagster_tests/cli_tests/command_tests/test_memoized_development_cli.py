...
def test_execute_versioned_command():
    with seven.TemporaryDirectory() as temp_dir:
        ...
        kwargs = {
            ...
            "python_file": "dagster_tests/cli_tests/command_tests/memoized_development_basic_pipelines.py",
        ...
        kwargs["config"] = ("dagster_tests/cli_tests/command_tests/basic_pipeline_config_2.yaml",)
