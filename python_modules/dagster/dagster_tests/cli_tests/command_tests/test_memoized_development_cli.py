...
def test_execute_versioned_command():
    with seven.TemporaryDirectory() as temp_dir:
        ...
        kwargs = {
            "config": (
                "python_modules/dagster/dagster_tests/cli_tests/command_tests/basic_pipeline_config_1.yaml",
            ),
            "pipeline": "basic_pipeline",
            "python_file": "python_modules/dagster/dagster_tests/cli_tests/command_tests/memoized_development_basic_pipelines.py",
        ...
        kwargs["config"] = (
            "python_modules/dagster/dagster_tests/cli_tests/command_tests/basic_pipeline_config_2.yaml",
        )
