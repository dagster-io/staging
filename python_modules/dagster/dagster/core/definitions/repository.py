...
RepositoryLevelDefinition = Union[PipelineDefinition, PartitionSetDefinition, ScheduleDefinition]
...
class _CacheingDefinitionIndex:
    def __init__(
        ...
        self._lazy_definitions_fn = lazy_definitions_fn
    ...
    def get_lazy_definitions(self):
        if self._lazy_definitions is None and self._lazy_definitions_fn:
    ...
    def get_definition_names(self) -> List[str]:
        ...
        self._definition_names = list(self._definitions.keys()) + [
            definition.name for definition in self.get_lazy_definitions()
        ]
        return self._definition_names
