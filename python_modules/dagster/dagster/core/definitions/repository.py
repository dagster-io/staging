...
class IRepositoryData(ABC):
    ...
    subclass :py:class:`IRepositoryData` for fine-grained control over access to and lazy creation
    ...
    def has_partition_set(self, _partition_set_name):
    ...
    def has_schedule(self, _schedule_name):
        return False

    def get_all_sensors(self):
        return []

    def get_sensor(self, _sensor_name):
        raise NotImplementedError

    def has_sensor(self, _sensor_name):
        return False


class RepositoryData(IRepositoryData):
    """Default implementation of IRepositoryData used by the :py:func:`@repository <repository>` decorator."""
...
class RepositoryDefinition:
    ...
    Args:
        ...
        repository_data (IRepositoryData): Contains the definitions making up the repository.
    ...
    def __init__(
        ...
        self._repository_data = check.inst_param(
            repository_data, "repository_data", IRepositoryData
        )
