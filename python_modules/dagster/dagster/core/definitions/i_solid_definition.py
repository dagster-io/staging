...
class NodeDefinition(ConfigurableDefinition):
    ...
    def has_configurable_inputs(self):
        warnings.warn(
            "NodeDefinition.has_configurable_inputs is deprecated because whether the node has "
            "configurable inputs depends on what RootInputManager is supplied in the mode."
        )
    ...
    def has_configurable_outputs(self):
        warnings.warn(
            "NodeDefinition.has_configurable_inputs is deprecated because whether the node has "
            "configurable inputs depends on what IOManager is supplied in the mode."
        )
