...
class SensorDefinition:
    ...
    def __init__(
        ...
        _is_pipeline_sensor: Optional[bool] = False,
    ):
        ...
        self._is_pipeline_sensor = check.opt_bool_param(
            _is_pipeline_sensor, "_is_pipeline_sensor", default=False
        )

        if self._is_pipeline_sensor:
    ...
    def is_pipeline_sensor(self):
        return self._is_pipeline_sensor
