...
def define_storage_field(
    mode_definition, config_cls_fn, keylist, defaults, not_provided=FIELD_NO_DEFAULT_PROVIDED,
):
...
def define_environment_cls(creation_data):
    ...
    intermediate_storage_field = define_storage_field(
        ...
        keylist=[dfn.name for dfn in creation_data.mode_definition.intermediate_storage_defs],
    ...
    if not (intermediate_storage_field.is_required or intermediate_storage_field.default_provided):
        storage_field = define_storage_field(
            ...
            keylist=[dfn.name for dfn in creation_data.mode_definition.system_storage_defs],
