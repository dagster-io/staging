...
class Backoff(Enum):
    ...
    """
    Linear delay multiplier: `attempt_num * delay`
    """
    LINEAR = "LINEAR"

    """
    Exponential delay multiplier: `((2 ^ attempt_num) - 1) * delay`
    """
...
class Jitter(Enum):
    ...
    """
    Jitter between 0 and the calculated delay based on backoff: `random() * backoff_delay`
    """
    FULL = "FULL"

    """
    Jitter +/- the delay: `backoff_delay + ((2 * (random() * delay)) - delay)`
    """
