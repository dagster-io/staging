...
class GraphDefinition(NodeDefinition):
    ...
    def to_job(
        ...
        config: Union[ConfigMapping, Dict[str, Any], "PartitionsConfig"] = None,
        ...
        if isinstance(config, ConfigMapping):
        ...
        elif isinstance(config, PartitionsConfig):
            partitions_config = config
            ...
            check.failed(
                f"config param must be a ConfigMapping, a PartitionsConfig, or a dictionary, but "
        ...
        return PipelineDefinition(
            ...
            mode_defs=[
                ModeDefinition(
                    ...
                    _partitions_config=partitions_config,
                )
            ],
            preset_defs=presets,
            tags=tags,
