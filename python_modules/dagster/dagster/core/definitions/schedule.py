...
class ScheduleDefinition(object):
    ...
    Args:
        ...
        execution_timezone (Optional[str]): Timezone in which the schedule should run. Only works
            with DagsterCommandLineScheduler. Defaults to UTC.
    """
    ...
    def __init__(
        ...
        # Require execution_timezone to be set explicitly for all schedules before 0.10.0
        # (or back-compat with the cron scheduler will be very difficult)
