...
class ScheduleExecutionContext(JobContext):
    ...
    def __init__(self, instance, scheduled_execution_time):
        ...
        self._scheduled_execution_time = (
...
class ScheduleDefinition(JobDefinition):
    ...
    def __init__(
        ...
        elif not run_config_fn:
            run_config_fn = lambda _context: check.opt_dict_param(run_config, "run_config")
        ...
        if tags_fn and tags:
            ...
            tags_fn = lambda _context: check.opt_dict_param(
                tags, "tags", key_type=str, value_type=str
            )
    ...
    def get_tags(self, context):
        ...
        tags = super(ScheduleDefinition, self).get_tags(context)
