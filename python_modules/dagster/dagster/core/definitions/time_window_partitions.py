...
def daily_partitioned_config(
    ...
    Args:
        ...
        execution_time (Optional[datetime.time]): The time of day at which each partition is
            bounded.
    """
...
def hourly_partitioned_config(
    ...
    Args:
        ...
        fmt (Optional[str]): The date format to use. Defaults to `%Y-%m-%d`.
        timezone (Optional[str]): The timezone in which each date should exist.
        execution_time (Optional[datetime.time]): The minute at which each partition should be bounded.
    """
...
def monthly_partitioned_config(
    ...
    Args:
        ...
        execution_time (Optional[datetime.time]): The time of day at which each partition is
            bounded.
        execution_day_of_month (Optional[int]): Which day of the month each partition bound should
            be on.
    """
...
def weekly_partitioned_config(
    ...
    Args:
        ...
        execution_time (Optional[datetime.time]): The time of day at which each partition is
            bounded.
        execution_day_of_week (Optional[int]): Which day of the week each weekly partition should be
            bounded on. 0 corresponds to Sunday.
    """
