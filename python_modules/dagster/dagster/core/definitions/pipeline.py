...
class PipelineDefinition:
    ...
    def __init__(
        ...
        versioning_strategy: Optional[Union[str, Callable[[], str]]] = None,
    ):
        ...
        if not callable(versioning_strategy):
            self.versioning_strategy: Optional[Union[Callable[[], str], str]] = check.opt_str_param(
