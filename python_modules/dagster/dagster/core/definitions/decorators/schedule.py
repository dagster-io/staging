...
"""
    ...
    execution_time_to_partition_fn = lambda d: pendulum.instance(d).subtract(
        weeks=1, days=day_difference, hours=execution_time.hour, minutes=execution_time.minute
    )
...
"""
    ...
    execution_time_to_partition_fn = lambda d: pendulum.instance(d).subtract(
        days=1, hours=execution_time.hour, minutes=execution_time.minute,
    )
