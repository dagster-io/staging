...
def do_composition(
    ...
    actual_input_defs = (
        ...
        else infer_input_definitions_for_composite_solid(decorator_name, name, fn)
    )
    ...
    if provided_output_defs is not None:
        ...
        actual_output_defs = infer_output_definitions(decorator_name, name, fn)
    ...
    output = None
    mapping = None
    enter_composition(name, "@composite_solid")
    try:
        output = fn(**kwargs)
