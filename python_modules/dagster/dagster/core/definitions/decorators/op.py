from typing import Any, Callable, Dict, List, Optional, Sequence, Set, TupleMeta, Union
        ...
        if self.out:
            ...
            if isinstance(self.out, Out):
                ...
                if len(self.out) == 1:
                    ...
                    if inferred_out.annotation and type(inferred_out.annotation) is not TupleMeta:
