...
def _validate_and_coerce_solid_result_to_iterator(result, context, output_defs):
    ...
    if inspect.isgenerator(result):
        raise DagsterInvariantViolationError(
            (
                f"Error in solid {context.solid.name}: You have returned a generator object from the body "
                "of the solid. This is unsupported behavior. Did you mean to yield events from this "
                "generator instead?"
