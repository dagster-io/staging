from typing import Any, Callable, Dict, FrozenSet, Generator, List, Optional, Set, Tuple, Union
...
from .dependency import DependencyDefinition, SolidHandle, SolidInvocation
...
class SolidDefinition(NodeDefinition):
    ...
    def all_dagster_types(self) -> Generator[DagsterType, None, None]:
        yield from self.all_input_output_types()

    def iterate_node_defs(self) -> Generator["SolidDefinition", None, None]:
        yield self
...
class CompositeSolidDefinition(GraphDefinition):
    ...
    def __init__(
        self,
        name: str,
        solid_defs: List[Union["SolidDefinition", "CompositeSolidDefinition"]],
        ...
        dependencies: Optional[
            Dict[Union[str, SolidInvocation], Dict[str, DependencyDefinition]]
        ] = None,
        description: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        positional_inputs: Optional[List[str]] = None,
