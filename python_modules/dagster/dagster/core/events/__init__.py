...
class DagsterEvent(
    ...
    @staticmethod
    def handled_output(step_context, output_name, manager_key, message_for_backcompat=None):
        ...
        return DagsterEvent.from_step(
            ...
            message=message_for_backcompat or message,
        )
