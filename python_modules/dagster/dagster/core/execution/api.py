...
def reexecute_pipeline(
    ...
    Parameters:
        ...
        step_selection (Optional[List[str]]): A list of step selection queries (including single
            ...
            - ['some_solid.compute']: select the execution step "some_solid" itself.
            - ['*some_solid.compute']: select the step "some_solid" and all its ancestors
                (upstream dependencies).
            - ['*some_solid.compute+++']: select the step "some_solid", all its ancestors,
