...
def execute_run_iterator(
    ...
    if pipeline_run.execution_plan_snapshot_id:
        ...
        execution_plan = ExecutionPlan.rebuild_from_snapshot(
            pipeline, pipeline_run.pipeline_name, execution_plan_snapshot,
        )
...
def execute_run(
    ...
    if pipeline_run.execution_plan_snapshot_id:
        ...
        execution_plan = ExecutionPlan.build(
            pipeline, environment_config, step_keys_to_execute=pipeline_run.step_keys_to_execute,
        )
    ...
    if is_memoized_run(pipeline_run.tags):
        ...
        execution_plan = resolve_memoized_execution_plan(execution_plan, environment_config)
