...
class GraphExecutionResult:
    def __init__(
        ...
        self.hardcoded_resource_instances = check.opt_dict_param(
            hardcoded_resource_instances, "hardcoded_resource_instances", str
        )
    ...
    def _result_for_handle(self, solid, handle):
        ...
        if solid.is_composite:
            ...
            return CompositeSolidExecutionResult(
                ...
                hardcoded_resource_instances=self.hardcoded_resource_instances,
            )
        else:
            for event in self.event_list:
                if event.is_step_event:
...
class SolidExecutionResult:
    ...
    def __init__(
        self, solid, step_events_by_kind, reconstruct_context, hardcoded_resource_instances=None
    ):
        check.inst_param(solid, "solid", Solid)
        check.invariant(
    ...
    def output_values(self):
        ...
        results = {}
        with self.reconstruct_context(self.hardcoded_resource_instances) as context:
