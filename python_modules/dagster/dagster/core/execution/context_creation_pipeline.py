...
class ExecutionContextManager(ABC):
    ...
    def event_generator(
        ...
        resource_instances_not_to_reinit = check.opt_dict_param(
...
def scoped_pipeline_context(
    ...
    initialization_manager = PipelineExecutionContextManager(
        ...
        intermediate_storage=intermediate_storage,
        raise_on_error=raise_on_error,
        resource_instances_not_to_reinit=resource_instances_not_to_reinit,  # {"mem_object_manager": mem_object_manager}
    )
