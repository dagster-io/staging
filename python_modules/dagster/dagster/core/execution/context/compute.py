...
class SolidExecutionContext(AbstractComputeExecutionContext):
    ...
    def solid_def(self) -> SolidDefinition:
        ...
        return (
            self.pipeline_def.get_solid(self.solid_handle).definition if self.pipeline_def else None
        )
...
@contextmanager
def build_solid_execution_context(
    resources: Optional[Dict[str, Any]] = None,
    solid_config: Optional[Dict[str, Any]] = None,
) -> Generator["SolidExecutionContext", None, None]:
    ...
    with build_resources(resources) as resource_instances:

        yield SolidExecutionContext(
