...
class HostModeExecutionContextData(
    namedtuple(
        ...
        ("pipeline_run recon_pipeline execution_plan instance raise_on_error retry_mode"),
    )
):
    def __new__(
        cls,
        ...
        return super(HostModeExecutionContextData, cls).__new__(
            ...
            recon_pipeline=check.inst_param(
                recon_pipeline, "recon_pipeline", ReconstructablePipeline
            ),
