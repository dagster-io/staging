...
def _get_resource_config_from_step_context(step_context, name):
    manager_key = None
    for output_def in step_context.solid_def.output_defs:
    ...
    return step_context.environment_config.resources[manager_key].get("config", {})
...
def get_output_context(
    ...
    resource_config = _get_resource_config_from_step_context(
        step_context, step_output_handle.output_name
    )
