...
class OutputContext(
    namedtuple(
        "_OutputContext",
        "step_key name run_id pipeline_name metadata mapping_key config solid_def log version",
    )
):
    """
    Attributes:
...
class InputContext(
    namedtuple(
        "_InputContext",
        "input_name pipeline_name solid_def input_config input_metadata upstream_output log",
    )
):
    """
