...
class IPlanContext(ABC):
    ...
    def log(self) -> DagsterLogManager:
        return self.plan_data.log_manager
...
class StepOrchestrationContext(PlanOrchestrationContext, IStepContext):
    def __init__(self, plan_data, executor, step, output_capture):
        super(StepOrchestrationContext, self).__init__(plan_data, executor, output_capture)
        self._step = step
...
class PlanExecutionContext(IPlanContext):
    ...
    def for_step(self, step: ExecutionStep) -> IStepContext:
        return StepExecutionContext(self.plan_data, self._execution_data, step, self.output_capture)
...
class StepExecutionContext(PlanExecutionContext, IStepContext):
    def __init__(self, plan_data, execution_data, step, output_capture):
