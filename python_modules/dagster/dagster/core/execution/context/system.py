...
class SystemStepExecutionContext(SystemExecutionContext):
    ...
    def get_output_context(self, step_output_handle):
        ...
        return OutputContext(
            ...
            metadata=self.execution_plan.get_step_output(step_output_handle).output_def.metadata,
...
class OutputContext(
    namedtuple(
        "_StepOutputInfo", "step_key name metadata run_id pipeline_name config solid_def version"
    )
):
    """
    Attributes:
