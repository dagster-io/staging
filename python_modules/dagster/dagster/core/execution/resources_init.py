...
def get_required_resource_keys_for_step(
    ...
    for step_input in execution_step.step_inputs:
        ...
        # Note: this won't catch config in a fan-in, which also needs to
        # deal with getting the inner type's loader
        ...
        for source_handle in step_input.source.step_dependency_handles:
