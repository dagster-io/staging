...
class MappedStepHandle(namedtuple("_ResolvedStepHandle", "solid_handle mapping_key")):
    """
    A reference to an ExecutionStep that was determined dynamically. This step was downstream
    of a mapping output.
    """
