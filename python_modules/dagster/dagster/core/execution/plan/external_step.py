...
from dagster.core.execution.context.system import StepExecutionContext, StepOrchestrationContext
...
class LocalExternalStepLauncher(StepLauncher):
    ...
    def launch_step(
        self,
        step_context: Union[StepExecutionContext, StepOrchestrationContext],
...
def step_context_to_step_run_ref(
    step_context: Union[StepOrchestrationContext, StepExecutionContext],
    prior_attempts_count: int,
