...
from dagster.core.execution.context.system import UserCodeStepExecutionContext
from dagster.core.execution.context_creation_pipeline import UserCodePlanExecutionContextManager
...
class LocalExternalStepLauncher(StepLauncher):
    ...
    def launch_step(
        self, step_context: UserCodeStepExecutionContext, prior_attempts_count: int
...
def step_context_to_step_run_ref(
    ...
    """
    Args:
        step_context (UserCodeStepExecutionContext): The step context.
...
def step_run_ref_to_step_context(
    ...
    initialization_manager = UserCodePlanExecutionContextManager(
