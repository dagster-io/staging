...
from .handle import DynamicStepHandle, StepHandle, UnresolvedStepHandle
...
class ExecutionStep(
    ...
    def __new__(
        ...
        return super(ExecutionStep, cls).__new__(
            cls,
            handle=check.inst_param(handle, "handle", (StepHandle, DynamicStepHandle)),
    ...
    def get_mapping_key(self):
        if isinstance(self.handle, DynamicStepHandle):
        ...
        for output_name, mapped_keys in mappings.items():
            ...
            for mapped_key in mapped_keys:
                ...
                execution_steps.append(
                    ExecutionStep(
                        handle=DynamicStepHandle(self.handle.solid_handle, mapped_key),
