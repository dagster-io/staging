...
from dagster.core.execution.plan.inputs import StepInputSource
...
def _input_values_from_intermediate_storage(step_context):
    ...
    for step_input in step.step_inputs:
        ...
        value = step_input.source.load_object(
            step_context=step_context,
            dagster_type=step_input.dagster_type,
            input_name=step_input,
...
def _value_for_input_source(step_context, input_name, dagster_type, source, check_for_missing):
    ...
    return source.load_object(step_context, dagster_type, input_name, check_for_missing)
