...
def inner_plan_execution_iterator(
    pipeline_context: UserCodePlanExecutionContext, execution_plan: ExecutionPlan
...
def _trigger_hook(
    step_context: UserCodeStepExecutionContext, step_event_list: List[DagsterEvent]
) -> Iterator[DagsterEvent]:
...
def _dagster_event_sequence_for_step(
    step_context: UserCodeStepExecutionContext, retry_state: RetryState
) -> Iterator[DagsterEvent]:
    """
