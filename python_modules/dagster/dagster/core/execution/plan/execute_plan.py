...
def _trigger_hook(
    ...
    for hook_def in hook_defs:
        ...
        try:
            ...
            yield DagsterEvent.hook_errored(hook_context, hook_execution_error, step_context)
            continue
        ...
        if hook_execution_result and hook_execution_result.is_skipped:
            ...
            yield DagsterEvent.hook_skipped(hook_context, hook_def, step_context)
        else:
            # hook_fn finishes successfully
            yield DagsterEvent.hook_completed(hook_context, hook_def, step_context)
