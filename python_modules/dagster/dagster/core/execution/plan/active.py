...
from dagster.core.errors import DagsterExecutionInterruptedError, DagsterUnknownStepStateError
...
class ActiveExecution:
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        check.invariant(
            self.is_complete, "Execution plan should always be complete before exiting normally"
        )
