...
class ActiveExecution(AbstractContextManager):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if self.is_complete and len(self._lost_steps) > 0:
    ...
    def get_steps_to_execute(self, limit=None):
        check.invariant(
            self._context_guard, "ActiveExecution must be used as a context mangager",
        )
