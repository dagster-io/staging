...
class StepInputSource:
    ...
    def load_object(self, step_context, dagster_type, input_name, check_for_missing):
        pass
...
class FromMultipleSources(namedtuple("_FromMultipleSources", "sources"), StepInputSource):
    ...
    def load_object(self, step_context, dagster_type, input_name, check_for_missing):
        ...
        for inner_source in self.sources:
            value = inner_source.load_object(
                step_context=step_context,
                dagster_type=dagster_type.get_inner_type_for_fan_in(),
                input_name=input_name,
