...
class FromStepOutput(
    ...
    def required_resource_keys(self, _pipeline_def: PipelineDefinition):
        return set()
...
class FromDefaultValue(
    NamedTuple(
        "_FromDefaultValue", [("solid_handle", SolidHandle), ("input_name", str), ("value", Any)],
    ),
    StepInputSource,
):
    ...
    def __new__(
        cls, solid_handle: SolidHandle, input_name: str, value,
    ):
        return super(FromDefaultValue, cls).__new__(cls, solid_handle, input_name, value)
