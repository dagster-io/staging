...
class FromStepOutput(
    namedtuple("_FromStepOutput", "step_output_handle input_def_snap config_data fan_in"),
    StepInputSource,
):
    """This step input source is the output of a previous step"""

    def __new__(cls, step_output_handle, input_def_snap, config_data, fan_in):
...
class FromPendingDynamicStepOutput(
    namedtuple("_FromPendingDynamicStepOutput", "step_output_handle input_def_snap config_data"),
):
    """
    ...
    def __new__(cls, step_output_handle, input_def_snap, config_data):
...
class FromUnresolvedStepOutput(
    namedtuple(
        "_FromUnresolvedStepOutput", "unresolved_step_output_handle input_def_snap config_data"
    ),
):
    """
    ...
    def __new__(cls, unresolved_step_output_handle, input_def_snap, config_data):
        from dagster.core.snap.solid import InputDefSnap
