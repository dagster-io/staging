...
if TYPE_CHECKING:
    ...
    from dagster.core.execution.context.system import UserCodeStepExecutionContext, InputContext
...
class StepInputSource(ABC):
    ...
    @abstractmethod
    def load_input_object(self, step_context: "UserCodeStepExecutionContext"):
    ...
    def get_asset_lineage(
        self, _step_context: "UserCodeStepExecutionContext"
...
class FromRootInputManager(
    ...
    def load_input_object(
        self, step_context: "UserCodeStepExecutionContext"
...
class FromStepOutput(
    ...
    def get_load_context(self, step_context: "UserCodeStepExecutionContext") -> "InputContext":
...
class FromConfig(
    ...
    def load_input_object(self, step_context: "UserCodeStepExecutionContext") -> Any:
