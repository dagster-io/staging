...
from dagster.core.definitions.resource import ScopedResources
...
def _get_resources_as_dict(resources):
    if isinstance(resources, dict):
        return resources
    elif isinstance(resources, ScopedResources):
        return {key: getattr(resources, key) for key in resources.as_dict()}
...
def execute_in_process(
    ...
    resources: Optional[Union[Dict[str, Union[Any, ResourceDefinition]], ScopedResources]] = None,
    ...
    resources = check.opt_inst_param(resources, "resources", (dict, ScopedResources))
