...
def _resolve_step_events_by_kind(event_list: List[DagsterEvent]) -> Dict[StepKind, DagsterEvent]:
    step_events_by_kind: Dict[StepKind, DagsterEvent] = {}
    for event in event_list:
        ...
        res = io_manager.load_input(
            InputContext(
                ...
                upstream_output=OutputContext(
                    ...
                    version=None,
                    step_context=None,
                    resource_config=None,  # TODO: ADD THIS
