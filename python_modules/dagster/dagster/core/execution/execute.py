...
from dagster.core.definitions.dependency import SolidHandle, SolidInvocation
...
def execute_in_process(
    ...
    dependencies: Dict[Union[str, SolidInvocation], Dict[str, DependencyDefinition]] = defaultdict(
        dict
    )
