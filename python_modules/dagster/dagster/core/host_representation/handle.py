...
def _assign_python_env_location_name(loadable_target_origin):
    ...
    if loadable_target_origin.attribute:
        return loadable_target_origin.attribute
    if loadable_target_origin.module_name:
        return loadable_target_origin.module_name
    return loadable_target_origin.python_file
...
class PythonEnvRepositoryLocationHandle(
    namedtuple('_PythonEnvRepositoryLocationHandle', 'location_name loadable_target_origin'),
    RepositoryLocationHandle,
):
