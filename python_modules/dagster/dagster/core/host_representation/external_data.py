...
class ExternalSensorData(
    namedtuple(
        "_ExternalSensorData",
        "name pipeline_name solid_selection mode min_interval description is_monitor_sensor",
    )
):
    def __new__(
        cls,
        ...
        return super(ExternalSensorData, cls).__new__(
            ...
            description=check.opt_str_param(description, "description"),
            is_monitor_sensor=check.opt_bool_param(is_monitor_sensor, "is_monitor_sensor"),
        )
...
def external_sensor_data_from_def(sensor_def):
    return ExternalSensorData(
        ...
        is_monitor_sensor=sensor_def.is_monitor_sensor,
    )
