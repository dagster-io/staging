...
class RepositoryLocation(six.with_metaclass(ABCMeta)):
    ...
    def get_external_sensor_execution_data(
        self, instance, repository_handle, name, last_checked_time
    ):
        pass
...
class InProcessRepositoryLocation(RepositoryLocation):
    ...
    def get_external_sensor_execution_data(
        ...
        return get_external_sensor_execution(
            self._recon_repo, instance.get_ref(), name, last_checked_time
        )
...
class GrpcServerRepositoryLocation(RepositoryLocation):
    ...
    def get_external_sensor_execution_data(
        ...
        return sync_get_external_sensor_execution_data_grpc(
            self._handle.client, instance, repository_handle, name, last_checked_time
        )
