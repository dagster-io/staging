...
class InMemoryTestRunLauncher(RunLauncher, ConfigurableClass):
    def __init__(self, inst_data=None):
        self._inst_data = inst_data
        self._queue = []
    ...
    def launch_run(self, instance, run, external_pipeline):
        ...
        dagster_pipeline_start_event = DagsterEvent(
            message="started in mocked test run launcher",
        ...
        instance.handle_run_event(run.run_id, dagster_pipeline_start_event)
