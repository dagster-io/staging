...
# A sentinel that can be returned by a root input manager's load_input to indicate that the
# framework should fall back to using the default value, or fail if there is none.
CANNOT_LOAD_INPUT = object()
