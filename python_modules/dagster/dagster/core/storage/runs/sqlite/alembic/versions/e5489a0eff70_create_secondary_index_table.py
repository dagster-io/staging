...
Revision ID: e5489a0eff70
Revises: c63a27054f08
Create Date: 2020-10-19 10:23:33.168967
...
def upgrade():
    ...
    if "runs" in has_tables and "secondary_indexes" not in has_tables:
        # create table
        op.create_table(
            "secondary_indexes",
...
def downgrade():
    ...
    inspector = reflection.Inspector.from_engine(bind)
    has_tables = inspector.get_table_names()
    if "runs" in has_tables and "secondary_indexes" in has_tables:
