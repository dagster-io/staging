        ...
        with self.connect() as conn:
            ...
            for row in rows:
                try:
                    ...
                    # Since heartbeats are relatively transient, don't worry about
                    # back-compat for old heartbeats that can't deserialize - the next
                    # stored heartbeat will be in the new correct format
                    pass
