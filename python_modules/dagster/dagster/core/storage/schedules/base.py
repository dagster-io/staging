...
from dagster.core.scheduler.job import JobState, JobStatus, JobTick, JobTickData
...
class ScheduleStorage(abc.ABC):
    ...
    @abc.abstractmethod
    def purge_job_ticks(self, job_origin_id: str, tick_status: JobTickStatus, before: datetime.datetime):
