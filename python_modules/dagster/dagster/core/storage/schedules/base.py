...
class ScheduleStorage(abc.ABC):
    ...
    def validate_running_schedules(self, scheduler_class):
        ...
        for schedule in stored_schedules:
            ...
            if stored_scheduler_class and stored_scheduler_class != scheduler_class:
                ...
                raise DagsterScheduleWipeRequired(
                    ...
                    + f"To fix this, change the scheduler on your instance back to the previous "
                    + "scheduler configuration and run the command 'dagster schedule wipe'. It will then be safe to change "
                    + f"back to {instance_scheduler_class}."
                )
