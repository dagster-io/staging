...
JobTable = db.Table(
    ...
    db.Column("create_timestamp", db.DateTime, server_default=sql.get_current_timestamp()),
    db.Column("update_timestamp", db.DateTime, server_default=sql.get_current_timestamp()),
)
