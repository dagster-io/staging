...
JobTable = db.Table(
    ...
    db.Column("repository_origin_id", db.String(255)),
    db.Column("status", db.String(63)),
    db.Column("job_type", db.String(63)),
...
JobTickTable = db.Table(
    ...
    db.Column("tick_timestamp", db.types.TIMESTAMP),
    db.Column("tick_body", db.String),
    db.Column("create_timestamp", db.DateTime, server_default=db.text("CURRENT_TIMESTAMP")),
    db.Column("update_timestamp", db.DateTime, server_default=db.text("CURRENT_TIMESTAMP")),
)

db.Index("idx_job_tick_origin_key", JobTickTable.c.job_origin_id)
db.Index("idx_job_tick_execution_key", JobTickTable.c.job_origin_id, JobTickTable.c.execution_key)
db.Index("idx_job_tick_timestamp_key", JobTickTable.c.job_origin_id, JobTickTable.c.tick_timestamp)
