...
class ObjectStoreIntermediateStorage(IntermediateStorage):
    ...
    def get_intermediate(
        ...
        if self.type_storage_plugin_registry.is_registered(dagster_type):
            return self.type_storage_plugin_registry.get(dagster_type.unique_name).get_intermediate_object(
                self, context, dagster_type, step_output_handle
            )
        elif dagster_type.unique_name is None:
    ...
    def set_intermediate(
        ...
        if self.type_storage_plugin_registry.is_registered(dagster_type):
            return self.type_storage_plugin_registry.get(dagster_type.unique_name).set_intermediate_object(
