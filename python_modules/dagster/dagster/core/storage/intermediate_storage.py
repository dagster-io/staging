...
from dagster.core.types.dagster_type import CompositeDagsterType, DagsterType, resolve_dagster_type
...
class ObjectStoreIntermediateStorage(IntermediateStorage):
    ...
    def set_intermediate(
        ...
        elif dagster_type.name is None or isinstance(dagster_type, CompositeDagsterType):
            self.type_storage_plugin_registry.check_for_unsupported_composite_overrides(
                dagster_type
            )
