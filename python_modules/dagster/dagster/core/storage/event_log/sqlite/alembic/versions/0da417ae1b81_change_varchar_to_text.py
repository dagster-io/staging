    ...
    if has_table("event_logs"):
        with op.batch_alter_table("event_logs") as batch_op:
            batch_op.alter_column(
                "step_key", type_=sa.Text, existing_type=sa.String,
            )
            batch_op.alter_column(
                "asset_key", type_=sa.Text, existing_type=sa.String,
            )
            batch_op.alter_column(
                "partition", type_=sa.Text, existing_type=sa.String,
            )
...
def downgrade():
    if has_table("event_logs"):
        with op.batch_alter_table("event_logs") as batch_op:
            batch_op.alter_column(
                "step_key", type_=sa.String, existing_type=sa.Text,
            )
            batch_op.alter_column(
                "asset_key", type_=sa.String, existing_type=sa.Text,
            )
            batch_op.alter_column(
                "partition", type_=sa.String, existing_type=sa.Text,
            )
