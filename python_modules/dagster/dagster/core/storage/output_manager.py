...
class OutputManagerDefinition(ResourceDefinition, IOutputManagerDefinition):
    ...
    :py:class:`OutputManager`.  OutputManagers are used to materialize the outputs of solids.
    """
...
class OutputManager(ABC):
    """OutputManagers are used to materialize the outputs of solids.
...
def output_manager(config_schema=None, description=None, output_config_schema=None, version=None):
    ...
    materialize an object that is yielded as one of the outputs of a solid.
