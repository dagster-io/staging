...
class TypeStoragePluginRegistry(object):
    ...
    def is_registered(self, dagster_type):
        if dagster_type.unique_name is not None and dagster_type.unique_name in self._registry:
            return True
        return False
    ...
    def check_for_unsupported_composite_overrides(self, dagster_type):
        ...
        composite_overrides = {
            t.unique_name for t in dagster_type.inner_types if t.unique_name in self._registry
        }
