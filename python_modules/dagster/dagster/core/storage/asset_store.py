...
class VersionedPickledObjectFilesystemAssetStore(AssetStore):
    def __init__(self, base_dir=None):
        self.base_dir = check.opt_str_param(base_dir, "base_dir")
        self.write_mode = "wb"
        self.read_mode = "rb"
    ...
    def set_asset(self, context, obj):
        ...
        by the Asset Catalog.
        """
        check.invariant(context.version is not None)

        filepath = self._get_path(context.step_key, context.output_name, context.version)
