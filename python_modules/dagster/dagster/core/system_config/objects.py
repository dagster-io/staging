...
class EnvironmentConfig(
    ...
    def build(pipeline_def, run_config=None, mode=None):
        ...
        run_config = run_config_storage_field_backcompat(run_config)
...
# def config_map_intermediate_storage_backcompat(config_value, intermediate_storage_defs):
#     """This method will be replaced with a simple call to config_mapped_intermediate_storage_configs.
...
#     ipdb.set_trace()
#     if config_value.get("storage") and config_mapped_intermediate_storage_configs is None:
#         config_mapped_intermediate_storage_configs = config_map_objects(
#             config_value,
#             intermediate_storage_defs,
#             "storage",
...
#     return IntermediateStorageConfig.from_dict(config_mapped_intermediate_storage_configs)
