...
from .workspace import WorkspaceLocationEntry, WorkspaceLocationLoadStatus
...
class WorkspaceProcessContext(IWorkspaceProcessContext):
    ...
    def __init__(
        ...
        self._state_subscribers: List[LocationStateSubscriber] = [self._location_state_subscriber]
