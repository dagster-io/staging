...
class DagsterInstance:
    ...
    def create_run_for_pipeline(
        ...
        check.invariant(execution_plan.step_keys_to_execute is None)
        ...
        if _is_memoized_run(tags):
            ...
            step_versions = resolve_step_versions(full_execution_plan)
        ...
        subsetted_execution_plan = full_execution_plan.build_subset_plan(step_keys_to_execute)
