...
@contextmanager
def get_repository_location_from_kwargs(instance, kwargs):
    with get_workspace_from_kwargs(instance, kwargs) as workspace:
...
@contextmanager
def get_external_repository_from_kwargs(instance, kwargs):
    with get_repository_location_from_kwargs(instance, kwargs) as repo_location:
        provided_repo_name = kwargs.get("repository")
...
@contextmanager
def get_external_pipeline_from_kwargs(instance, kwargs):
    with get_external_repository_from_kwargs(instance, kwargs) as external_repo:
        provided_pipeline_name = kwargs.get("pipeline")
