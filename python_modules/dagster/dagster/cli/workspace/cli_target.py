...
def get_repository_location_from_workspace(workspace: Workspace, provided_location_name):
    if provided_location_name is None and workspace.repository_locations_count == 1:
