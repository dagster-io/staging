...
class WorkspaceSnapshot(
    ...
    def __new__(cls, location_origin_dict, _location_error_dict, repository_locations_dict):
        return super(WorkspaceSnapshot, cls).__new__(
            cls,
            location_origin_dict,
            _location_error_dict,
...
class Workspace(IWorkspace):
    ...
    def _start_watch_thread(self, origin):
        ...
        assert location_name not in self._watch_thread_shutdown_events
