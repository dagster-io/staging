...
class WorkspaceLocationEntry(
    namedtuple(
        "WorkspaceLocationEntry",
        "origin repository_location load_error load_status display_metadata update_timestamp",
    )
):
    def __new__(
        cls,
        ...
        return super(WorkspaceLocationEntry, cls).__new__(
            cls,
            check.inst_param(origin, "origin", RepositoryLocationOrigin),
            check.opt_inst_param(repository_location, "repository_location", RepositoryLocation),
            check.opt_inst_param(load_error, "load_error", SerializableErrorInfo),
            check.inst_param(load_status, "load_status", WorkspaceLocationLoadStatus),
            check.dict_param(display_metadata, "display_metadata", key_type=str, value_type=str),
