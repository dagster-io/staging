...
def execute_list_command(cli_args, print_fn):
    with DagsterInstance.get() as instance:
        with get_external_repository_from_kwargs(instance, cli_args) as external_repository:
...
def execute_print_command(instance, verbose, cli_args, print_fn):
    with get_external_pipeline_from_kwargs(instance, cli_args) as external_pipeline:
...
def execute_backfill_command(cli_args, print_fn, instance):
    with get_workspace_from_kwargs(instance, cli_args) as workspace:
