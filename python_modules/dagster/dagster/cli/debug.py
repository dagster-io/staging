...
from dagster.core.snap import ExecutionPlanSnapshot, PipelineSnapshot, execution_plan_snapshot
...
@click.command(name="export", help="Export ")
    ...
    with DagsterInstance.get() as instance:
        ...
        if run is None:
            raise click.UsageError(
                ...
                "Recently failed runs:\n{}".format(run_id, _recent_failed_runs_text(instance))
            )
        ...
        with gzip.GzipFile(output_file, "wb") as file:
