...
def get_external_sensor_execution(recon_repo, instance_ref, sensor_name, last_checked_timestamp):
    check.inst_param(
        recon_repo, "recon_repo", ReconstructableRepository,
    )
    ...
    with DagsterInstance.from_ref(instance_ref) as instance:
        sensor_context = SensorExecutionContext(instance, last_checked_time=last_checked_timestamp)
