...
class SensorExecutionArgs(
    namedtuple(
        "_SensorExecutionArgs", "repository_origin instance_ref sensor_name last_checked_time"
    )
):
    def __new__(cls, repository_origin, instance_ref, sensor_name, last_checked_time):
        return super(SensorExecutionArgs, cls).__new__(
            ...
            last_checked_time=check.opt_float_param(last_checked_time, 'last_checked_time'),
        )
