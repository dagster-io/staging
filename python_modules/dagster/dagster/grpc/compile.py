...
PROTOS_PATHS = [os.path.join(PROTOS_DIR, f) for f in ["api.proto"]]

GENERATED_DIR = file_relative_path(__file__, "__generated__")

GENERATED_PB2_PATHS = [os.path.join(GENERATED_DIR, f) for f in ["api_pb2.py"]]

GENERATED_GRPC_PATHS = [os.path.join(GENERATED_DIR, f) for f in ["api_pb2_grpc.py"]]
