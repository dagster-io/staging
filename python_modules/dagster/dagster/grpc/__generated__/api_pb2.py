...
_DAGSTERAPI = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="UpdateServerId",
            full_name="api.DagsterApi.UpdateServerId",
            index=4,
            containing_service=None,
            input_type=_EMPTY,
            output_type=_GETSERVERIDREPLY,
