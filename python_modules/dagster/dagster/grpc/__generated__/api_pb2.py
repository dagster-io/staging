...
_SHUTDOWNSERVERREQUEST = _descriptor.Descriptor(
    name='ShutdownServerRequest',
    full_name='api.ShutdownServerRequest',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='hard',
            full_name='api.ShutdownServerRequest.hard',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
DESCRIPTOR.message_types_by_name['ShutdownServerRequest'] = _SHUTDOWNSERVERREQUEST
...
ShutdownServerRequest = _reflection.GeneratedProtocolMessageType(
    'ShutdownServerRequest',
    (_message.Message,),
    {
        'DESCRIPTOR': _SHUTDOWNSERVERREQUEST,
        '__module__': 'api_pb2'
        # @@protoc_insertion_point(class_scope:api.ShutdownServerRequest)
    },
)
_sym_db.RegisterMessage(ShutdownServerRequest)
...
_DAGSTERAPI = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            index=11,
            containing_service=None,
            input_type=_SHUTDOWNSERVERREQUEST,
