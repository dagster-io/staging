...
_GETSERVERIDREQUEST = _descriptor.Descriptor(
    name="GetServerIdRequest",
    full_name="api.GetServerIdRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="echo",
            full_name="api.GetServerIdRequest.echo",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_GETSERVERIDEVENT = _descriptor.Descriptor(
    name="GetServerIdEvent",
    full_name="api.GetServerIdEvent",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name="server_id",
            full_name="api.GetServerIdEvent.server_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name["GetServerIdRequest"] = _GETSERVERIDREQUEST
DESCRIPTOR.message_types_by_name["GetServerIdEvent"] = _GETSERVERIDEVENT
...
GetServerIdRequest = _reflection.GeneratedProtocolMessageType(
    "GetServerIdRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _GETSERVERIDREQUEST,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.GetServerIdRequest)
    },
)
_sym_db.RegisterMessage(GetServerIdRequest)

GetServerIdEvent = _reflection.GeneratedProtocolMessageType(
    "GetServerIdEvent",
    (_message.Message,),
    {
        "DESCRIPTOR": _GETSERVERIDEVENT,
        "__module__": "api_pb2"
        # @@protoc_insertion_point(class_scope:api.GetServerIdEvent)
    },
)
_sym_db.RegisterMessage(GetServerIdEvent)
...
_DAGSTERAPI = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            index=3,
            containing_service=None,
            input_type=_GETSERVERIDREQUEST,
            output_type=_GETSERVERIDEVENT,
            serialized_options=None,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(
