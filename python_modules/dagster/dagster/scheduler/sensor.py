...
from dagster.core.storage.tags import RUN_KEY_TAG, TICK_ID_TAG, build_tick_id_tag, check_tags
...
def _create_sensor_run(
    ...
    tags[TICK_ID_TAG] = build_tick_id_tag(str(context.tick_id), context.timestamp)
