...
class DagsterDaemon(AbstractContextManager):
            ...
            with gen_workspace(instance) as workspace:
                ...
                while not daemon_shutdown_event.is_set() and (
                    ...
                    self._check_add_heartbeat(
                        instance, daemon_uuid, heartbeat_interval_seconds, error_time_limit
                    )
    ...
    def _check_add_heartbeat(
        self, instance, daemon_uuid, heartbeat_interval_seconds, error_time_limit
    ):
        error_max_time = pendulum.now("UTC").subtract(seconds=error_time_limit)
