        ...
        with RepositoryLocationHandleManager() as location_manager:
            for run in sorted_runs:
                ...
                try:
                    ...
                    message = f"Caught an error for run {run.run_id} : {error_info.to_string()}. It will be marked as failed and dropped from the queue."

                    self._logger.error(message)
                    instance.report_run_failed(run, message)
