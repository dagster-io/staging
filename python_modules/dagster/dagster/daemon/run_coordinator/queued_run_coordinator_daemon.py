...
class _TagConcurrencyLimitsCounter:
    ...
    def __init__(self, tag_concurrency_limits, in_progress_runs):
        self._tag_concurrency_limits = tag_concurrency_limits
    ...
    def _get_limited_tags(self, run):
        return [
            tag_value for tag_value in run.tags.items() if tag_value in self._tag_concurrency_limits
        ]
...
class QueuedRunCoordinatorDaemon(DagsterDaemon):
    ...
    def __init__(
        ...
        self._tag_concurrency_limits = check.opt_dict_param(
