...
# How long after the last heartbeat will the daemon be considered healthy. Should always be greater
# than DEFAULT_DAEMON_INTERVAL_SECONDS
DAEMON_HEARTBEAT_TOLERANCE_SECONDS = 40
...
def get_daemon_status(instance, daemon_type, curr_time=None):
    ...
    maximum_tolerated_time = hearbeat_timestamp.add(seconds=(DAEMON_HEARTBEAT_TOLERANCE_SECONDS))
