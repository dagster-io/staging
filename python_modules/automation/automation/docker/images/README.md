...
4. Update `INTEGRATION_IMAGE_VERSION` and put up a diff with these planned changes.
...
4. Update `UNIT_IMAGE_VERSION` and put up a diff with these planned changes.
