    ...
    def inner(fn):
        ...
        def _wrapped_fn(context):
            ...
            if not context.instance.is_asset_aware:
                yield SkipReason("Instance is not asset-aware.")
                return
            ...
            result = fn(context, [event.dagster_event for event in events])
...
def get_toys_sensors():
    ...
    return [toy_file_sensor, s3_bucket_sensor, toy_asset_sensor]
