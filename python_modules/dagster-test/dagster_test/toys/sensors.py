...
from dagster.core.definitions.pipeline_sensor import PipelineSensorContext, pipeline_failure_monitor
...
def get_toys_sensors():
    ...
    def slack_on_pipeline_failure(context: PipelineSensorContext):
