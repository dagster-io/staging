...
from .log_asset import log_asset_pipeline
from .log_file import log_file_pipeline
from .log_s3 import log_s3_pipeline
...
def get_toys_sensors():
    ...
    @sensor(target=log_file_pipeline)
    ...
    @sensor(target=log_asset_pipeline)
