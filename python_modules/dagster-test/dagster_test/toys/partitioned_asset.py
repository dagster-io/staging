...
def emit_materialization(context):
    ...
    git_hash = "6564743f1138191c5d127ddcab28de387ad128f6"
    path = "python_modules/dagster-test/dagster_test/toys/partitioned_asset.py"
    github_url = f"https://github.com/dagster-io/dagster/blob/{git_hash}/{path}"
    ...
    yield AssetMaterialization(
        ...
        metadata_entries=[
            ...
            EventMetadataEntry.url(github_url, "Github URL", description=git_hash),
