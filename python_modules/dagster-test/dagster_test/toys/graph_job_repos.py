...
event_tables_schedule = ScheduleDefinition(
    name="event_tables_schedule", job=event_tables, cron_schedule="0 0 * * *"
)
...
crm_ingest_instance1_schedule = ScheduleDefinition(
    name="crm_ingest_instance1_schedule",
    job=crm_ingest.to_job(
        suffix="instance1", resource_defs={"crm": ResourceDefinition.none_resource()}
    ),
    cron_schedule="0 0 * * *",
)
crm_ingest_instance2_schedule = ScheduleDefinition(
    name="crm_ingest_instance2_schedule",
    job=crm_ingest.to_job(
        suffix="instance2", resource_defs={"crm": ResourceDefinition.none_resource()}
    ),
    cron_schedule="0 0 * * *",
)
