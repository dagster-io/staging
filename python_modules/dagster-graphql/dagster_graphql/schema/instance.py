...
GrapheneDaemonType = graphene.Enum.from_enum(DaemonType)
...
class GrapheneDaemonStatus(graphene.ObjectType):
    ...
    lastHeartbeatError = graphene.Field(GraphenePythonError)
    ...
    def __init__(self, daemon_status):
        ...
        if daemon_status.last_heartbeat:
            ...
            if daemon_status.last_heartbeat.error:
                last_heartbeat_error = GraphenePythonError(daemon_status.last_heartbeat.error)
