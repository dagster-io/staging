...
class GrapheneRepositoryLocationLoading(graphene.ObjectType):
    ...
    def resolve_metadata(self, graphene_info):
        return GrapheneRepositoryLocationMetadata(
            graphene_info.context.get_location_metadata(self.name)
        )
...
class GrapheneRepositoryLocation(graphene.ObjectType):
    ...
    def resolve_loadStatus(self, graphene_info):
        return GrapheneRepositoryLocationLoadStatus.from_python_status(
            graphene_info.context.get_load_status(self.name)
        )
