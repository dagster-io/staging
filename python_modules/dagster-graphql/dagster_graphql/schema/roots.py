...
class DauphinQuery(dauphin.ObjectType):
    ...
    sensorOrError = dauphin.Field(
        dauphin.NonNull("SensorOrError"), jobSelector=dauphin.NonNull("JobSelector"),
    )
    ...
    def resolve_sensorOrError(self, graphene_info, job_selector):
        return get_sensor_or_error(graphene_info, JobSelector.from_graphql_input(job_selector))
