...
from dagster_graphql.schema.external import get_pipeline_handle_state_change_observable
...
class DauphinSubscription(dauphin.ObjectType):
    ...
    handleStateChangeEvents = dauphin.Field(dauphin.NonNull("HandleStateChangeSubscription"))
    ...
    def resolve_handleStateChangeEvents(self, graphene_info):
        return get_pipeline_handle_state_change_observable(graphene_info)
