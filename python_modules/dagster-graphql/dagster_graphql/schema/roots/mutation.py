...
class GrapheneShutdownRepositoryLocationSucess(graphene.ObjectType):
    repositoryLocationName = graphene.NonNull(graphene.String)

    class Meta:
        name = "ShutdownRepositoryLocationSucess"


class GrapheneShutdownRepositoryLocationMutationResult(graphene.Union):
    class Meta:
        types = (
            GrapheneShutdownRepositoryLocationSucess,
            GrapheneRepositoryLocationNotFound,
            GrapheneReadOnlyError,
            GraphenePythonError,
        )
...
class GrapheneShutdownRepositoryLocationMutation(graphene.Mutation):
    ...
    def mutate(self, graphene_info, **kwargs):
        ...
        return GrapheneShutdownRepositoryLocationSucess(repositoryLocationName=location_name)
