...
class DauphinScheduleState(dauphin.ObjectType):
    ...
    def resolve_repository_origin(self, graphene_info):
        location_handle = RepositoryLocationHandle.create_from_repository_location_origin(
            self._schedule_state.origin.external_repository_origin.repository_location_origin
        )
        repo_handle = RepositoryHandle(
            self._schedule_state.origin.external_repository_origin.repository_name, location_handle
        )
        origin = repo_handle.get_origin()
