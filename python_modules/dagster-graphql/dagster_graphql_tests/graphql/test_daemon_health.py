...
query InstanceDetailSummaryQuery {
    instance {
        daemonHealth {
            sensor: daemonStatus(daemonType: SENSOR_DAEMON){
                daemonType
                required
                healthy
                lastHeartbeatTime
            }
            run_coordinator: daemonStatus(daemonType: QUEUED_RUN_COORDINATOR_DAEMON){
                daemonType
                required
                healthy
                lastHeartbeatTime
            }
            scheduler: daemonStatus(daemonType: DAGSTER_DAEMON_SCHEDULER){
                daemonType
                required
                healthy
                lastHeartbeatTime
    ...
    def test_get_individual_daemons(self, graphql_context):
        ...
        assert results.data == {
            "instance": {
                "daemonHealth": {
                    "sensor": {
                        "daemonType": "SENSOR_DAEMON",
                        "required": True,
                        "healthy": False,
                        "lastHeartbeatTime": None,
                    },
                    "run_coordinator": {
                        "daemonType": "QUEUED_RUN_COORDINATOR_DAEMON",
                        "required": False,
                        "healthy": None,
                        "lastHeartbeatTime": None,
                    },
                    "scheduler": {
                        "daemonType": "DAGSTER_DAEMON_SCHEDULER",
                        "required": False,
                        "healthy": None,
                        "lastHeartbeatTime": None,
                    },
