...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_in_memory_instance_out_of_process_env] 1'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
            {
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_in_memory_instance_out_of_process_env] 2'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
        ]
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_sqlite_instance_in_process_env] 1'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
            {
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_sqlite_instance_in_process_env] 2'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
        ]
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_sqlite_instance_out_of_process_env] 1'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
            {
...
snapshots['TestPartitionSets.test_get_partition_sets_for_pipeline[readonly_sqlite_instance_out_of_process_env] 2'] = {
    'partitionSetsOrError': {
        '__typename': 'PartitionSets',
        'results': [
        ]
