...
snapshots["TestComposites.test_composites[readonly_postgres_instance_in_process_env] 1"] = {
    "pipelineOrError": {
        "__typename": "Pipeline",
        "name": "composites_pipeline",
        "solidHandles": [
...
snapshots["TestComposites.test_composites[readonly_postgres_instance_managed_grpc_env] 1"] = {
    "pipelineOrError": {
        "__typename": "Pipeline",
        "name": "composites_pipeline",
        "solidHandles": [
