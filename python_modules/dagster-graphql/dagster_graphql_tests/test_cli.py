...
def test_basic_repository_locations():
    query = "{ workspaceOrError { ... on WorkspaceConnection { nodes { __typename, name, locationOrLoadError { __typename, ... on RepositoryLocation { __typename, name } ... on PythonError { message } } } } } }"
