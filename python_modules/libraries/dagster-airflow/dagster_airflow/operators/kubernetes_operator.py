...
class DagsterKubernetesPodOperator(KubernetesPodOperator):
    ...
    def execute(self, context):
        try:
            from dagster_k8s.utils import filter_dagster_events_from_pod_logs

        except ImportError:
            raise AirflowException(
                'To use the DagsterKubernetesPodOperator, dagster and dagster-k8s must be'
        ...
        try:
            ...
            try:
                ...
                while not events and num_attempts < LOG_RETRIEVAL_MAX_ATTEMPTS:
                    ...
                    events = filter_dagster_events_from_pod_logs(raw_res.split('\n'))
