...
from dagster.utils import frozentags, raise_interrupts_immediately
...
class DaskExecutor(Executor):
    ...
    def execute(self, pipeline_context, execution_plan):
        ...
        with dask.distributed.Client(cluster) as client:
            ...
            # If this execution is happening within a `delay_interrupts` context, allow interrupts
            # while waiting for dask to complete the actual execution so that we can terminate slow
            # or hanging tasks
