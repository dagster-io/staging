...
def write_notebook_output(
    ...
    solid_context.resources.io_manager.handle_output(context=output_context, obj=value)
...
def read_notebook_output(
    ...
    return solid_context.resources.io_manager.load_input(context=input_context)
