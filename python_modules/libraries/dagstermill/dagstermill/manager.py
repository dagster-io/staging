...
class Manager:
    ...
    def yield_result(self, value, output_name: str = "result"):
        ...
        system_context = solid_context._pipeline_context  # pylint: disable=protected-access
        io_manager = solid_context.resources.io_manager
        ...
        io_manager.handle_output(context=output_context, obj=value)
