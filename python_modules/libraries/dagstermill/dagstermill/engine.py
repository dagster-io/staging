...
if IS_PAPERMILL_2:
    ...
    from papermill.engines import NBConvertEngine  # pylint: disable=import-error
    from papermill.preprocess import PapermillExecutePreprocessor  # pylint: disable=import-error
