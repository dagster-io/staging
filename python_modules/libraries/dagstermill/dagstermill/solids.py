...
def _dm_solid_compute(name, notebook_path, output_notebook=None, asset_key_prefix=None):
    ...
    def _t_fn(step_context, inputs):
        ...
        system_step_context = step_context.get_system_context()
        ...
        with tempfile.TemporaryDirectory() as output_notebook_dir:
            with safe_tempfile_path() as output_log_path:
                ...
                nb_no_parameters = replace_parameters(
                    system_step_context,
                    nb,
                    get_papermill_parameters(system_step_context, inputs, output_log_path),
                )
            ...
            for (output_name, output_def) in system_step_context.solid_def.output_dict.items():
