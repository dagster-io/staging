...
def define_dagstermill_solid(
    ...
    warnings.warn(
        "dagstermill.define_dagstermill_solid is deprecated in 0.10.2 and will be removed in "
        "0.11.0. Please use dagstermill.dagstermill_solid instead.",
    )
...
def dagstermill_solid(
    ...
    Arguments:
        ...
        output_notebook_io_manager_key (Optional[str]): If set, will override the io manager key
