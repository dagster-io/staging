...
DAGSTER_K8S_CELERY_WORKER_IMAGE: "{{- .Values.celery.image.repository -}}:{{- .Values.celery.image.tag -}}"
DAGSTER_K8S_CELERY_WORKER_IMAGE_PULL_POLICY: "{{ .Values.celery.image.pullPolicy }}"
