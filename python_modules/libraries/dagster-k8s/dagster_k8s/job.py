...
class DagsterK8sJobConfig(
    ...
    Params:
        job_image (str): The docker image to use. The Job container will be launched with this
            image.
        job_command (Optional[Noneable[String]]): The command to use for the Job's container.
    ...
    def config_type_run_launcher(cls):
        ...
        return {
            ...
            "job_command": Field(
                ...
                description="The `dagster` command to run for the Job container. By default, this is just `dagster`"
                "If this is set to null, a job command will not be set.",
            ),
        }
