...
USER_DEFINED_K8S_CONFIG_SCHEMA = Shape(
    {
        ...
        'post_template_spec_config': Permissive(),
...
class UserDefinedDagsterK8sConfig(
    ...
    def __new__(
        ...
        pod_template_spec_config = check.opt_dict_param(
            pod_template_spec_config, 'pod_template_spec_config', key_type=str
        )
...
def get_user_defined_k8s_config(tags):
    ...
    return UserDefinedDagsterK8sConfig(
        container_config=container_config,
        pod_template_spec_config=user_defined_k8s_config.get('pod_template_spec_config'),
...
def construct_dagster_k8s_job(
    ...
    template = kubernetes.client.V1PodTemplateSpec(
        ...
        **user_defined_k8s_config.pod_template_spec_config
    )
