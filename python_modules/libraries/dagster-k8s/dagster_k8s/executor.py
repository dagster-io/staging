...
def k8s_job_executor(init_context: InitExecutorContext) -> Executor:
    ...
    job_config = DagsterK8sJobConfig(
        ...
        image_pull_policy=exc_cfg.get("image_pull_policy", run_launcher.image_pull_policy),
        image_pull_secrets=exc_cfg.get("image_pull_secrets", run_launcher.image_pull_secrets),
        service_account_name=exc_cfg.get("service_account_name", run_launcher.service_account_name),
        env_config_maps=exc_cfg.get("env_config_maps", run_launcher.env_config_maps),
