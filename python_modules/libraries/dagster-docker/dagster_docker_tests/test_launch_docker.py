...
def test_terminate_launched_docker_run():
    ...
    with docker_postgres_instance(
        ...
        assert terminated_pipeline_run.status == PipelineRunStatus.CANCELLED
        ...
        _check_event_log_contains(
            run_logs,
            [
                ("PIPELINE_CANCELLING", "Sending pipeline termination request"),
                ("STEP_FAILURE", 'Execution of step "hanging_solid.compute" failed.'),
                ("PIPELINE_CANCELLED", 'Execution of pipeline "hanging_pipeline" cancelled.'),
