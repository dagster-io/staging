...
def make_slack_on_pipeline_failure_sensor(
    channel: str,
    slack_token_name: Optional[str] = "SLACK_TOKEN",
    ...
    Args:
        ...
        slack_token_name (Optional[str]): The name of the slack token in your environment. Defaults
            to "SLACK_TOKEN".
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            @repository
            def my_repo():
                return my_pipelines + [slack_on_pipeline_failure]
    ...
    def slack_on_pipeline_failure(context: PipelineFailureSensorContext):
        ...
        slack_client = WebClient(token=os.environ[slack_token_name])
