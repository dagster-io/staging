...
class CliRunResult(RunResult):
    """The results of executing a dbt command, along with additional metadata about the dbt CLI
    process that was run.

    We recommend that you construct an instance of :class:`CliRunResult
    <dagster_dbt.CliRunResult>` by using the class method:func:`from_dict
    <dagster_dbt.CliRunResult.from_dict>`.
    ...
    def from_dict(cls, d: Dict[str, Any]) -> 'CliRunResult':
        ...
        Args:
            d (Dict[str, Any]): a dictionary with key-values to construct a :class:`CliRunResult
                <dagster_dbt.CliRunResult>`.

        Returns:
            CliRunResult: an instance of :class:`CliRunResult <dagster_dbt.CliRunResult>`.
        """
