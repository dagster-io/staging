...
def create_dbt_rpc_run_sql_solid(
    ...
    check.param_invariant("input_defs" not in kwargs, "input_defs", "Overriding input_defs is not supported.")
    check.param_invariant("required_resource_keys" not in kwargs, "required_resource_keys", "Overriding required_resource_keys is not supported.")
