...
from dagster.serdes import pack_value, serialize_dagster_namedtuple
...
def create_task(celery_app, **task_kwargs):
    ...
    def _execute_plan(self, execute_step_args_packed, executable_dict):
        ...
        check.invariant(pipeline_run, "Could not load run {}".format(execute_step_args.run_id))
        ...
        ).build_subset_plan(execute_step_args.step_keys)
