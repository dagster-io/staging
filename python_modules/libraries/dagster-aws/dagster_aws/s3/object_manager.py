...
from dagster import Field, ObjectManager, StringSource, check, resource
...
def s3_object_manager(init_context):
    ...
    .. code-block:: python
        ...
        pipeline_def = PipelineDefinition(
            mode_defs=[
                ModeDefinition(
                    resource_defs={'asset_store': s3_object_manager, ...},
                ), ...
            ], ...
        )
    ...
    asset_store = PickledObjectS3ObjectManager(s3_bucket, s3_prefix=s3_prefix)
    return asset_store
