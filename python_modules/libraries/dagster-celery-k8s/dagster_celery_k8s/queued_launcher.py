...
from dagster import DagsterInvariantViolationError, Field, Noneable, check
...
class CeleryK8sQueuedRunLauncher(RunLauncher, ConfigurableClass):
    ...
    def launch_run(self, instance, run, external_pipeline):
        ...
        task_signature.apply_async(
            queue='dagster', routing_key='dagster.execute_run_coordinator_k8s_job'
        )
...
def create_k8s_run_coordinator_job_task(celery_app, **task_kwargs):
    ...
    def _execute_run_coordinator_k8s_job(
        ...
        # TODO: wait for coordinator to finish
