...
def create_k8s_job_task(celery_app, **task_kwargs):
    ...
    def _execute_step_k8s_job(
        ...
        try:
            ...
            return []
        except (DagsterK8sUnrecoverableAPIError, DagsterK8sAPIRetryLimitExceeded) as e:
            instance.report_engine_event(
            ...
            # TODO: Send an error message that tell us we are not wrapping something properly
            return []
