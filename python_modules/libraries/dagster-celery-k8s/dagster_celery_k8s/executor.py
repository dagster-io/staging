...
from dagster_k8s.client import DagsterK8sPipelineStatusException, DagsterK8sStepFailureException
...
def create_k8s_job_task(celery_app, **task_kwargs):
    ...
    def _execute_step_k8s_job(
        ...
        def report_engine_event_for_step(message, extra_engine_event_data=None):
        ...
        #     report_engine_event_for_step("Encountered unexpected error (exiting)")
