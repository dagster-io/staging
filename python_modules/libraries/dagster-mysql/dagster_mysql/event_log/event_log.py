...
class MySQLEventLogStorage(AssetAwareSqlEventLogStorage, ConfigurableClass):
    ...
    def store_asset_key(self, conn, event):
        ...
        # TODO - ON CONFLICT DO NOTHING is not a statement in MySQL. Will need to explore alternatives.
        # conn.execute(
...
class MySQLEventWatcher:
    """MySQL-based Event Log Watcher
        ...
        Uses one thread (MySQLRunIdEventWatcherThread) per watched run_id
