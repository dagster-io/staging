...
def upgrade():
    ...
    if "event_logs" in has_tables and "event_log_secondary_indexes" not in has_tables:
        # create table
        op.create_table(
            "event_log_secondary_indexes",
...
def downgrade():
    ...
    inspector = reflection.Inspector.from_engine(bind)
    has_tables = inspector.get_table_names()
    if "event_logs" in has_tables and "event_log_secondary_indexes" in has_tables:
        op.drop_table("event_log_secondary_indexes")
