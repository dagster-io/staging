...
from ..utils import create_pg_connection, pg_config, pg_url_from_config, retry_pg_connection_fn
...
class PostgresRunStorage(SqlRunStorage, ConfigurableClass):
    ...
    def __init__(self, postgres_url, inst_data=None):
        ...
        retry_pg_connection_fn(lambda: RunStorageSqlMetadata.create_all(self._engine))
    ...
    def connect(self, run_id=None):  # pylint: disable=arguments-differ, unused-argument
        return create_pg_connection(self._engine, __file__, "run storage")
