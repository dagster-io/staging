...
def test_skip_autocreate(hostname, conn_string):
    TestPostgresInstance.clean_run_storage(conn_string, autocreate_tables=False)
    TestPostgresInstance.clean_event_log_storage(conn_string, autocreate_tables=False)
    TestPostgresInstance.clean_schedule_storage(conn_string, autocreate_tables=False)
