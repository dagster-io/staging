...
- io_manager_key and root_manager_key is disallowed o composite solids’ InputDefinitions and OutputDefinitions. Instead, custom IO managers on the solids inside composite solids will be respected:
...
- Invoking a solid more closely mirrors the functionality of the underlying decorated function.
