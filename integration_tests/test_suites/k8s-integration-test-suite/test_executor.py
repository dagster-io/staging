...
def test_k8s_run_launcher_default(
    ...
    with get_test_project_external_pipeline_hierarchy(pipeline_name) as (
        workspace,
        location,
        repo,
        external_pipeline,
...
def test_k8s_run_launcher_image_from_origin(
    ...
    with get_test_project_external_pipeline_hierarchy(pipeline_name, dagster_docker_image) as (
        workspace,
        location,
        repo,
        external_pipeline,
