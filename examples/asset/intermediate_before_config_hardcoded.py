    ...
    run_config_local_file = {
        "solids": {
            "raw_data": {
                ...
                "outputs": [{"source_data_df": {"csv": "uncommitted/cache/raw_df.csv"}}],
            },
            "preprocess": {
                # "inputs": {"source_data": {"csv": "uncommitted/cache/raw_df.csv"}},
                "outputs": [{"processed": {"csv": "uncommitted/cache/processed_df.csv"}}],
            },
            "daily_highs": {
                # "inputs": {"data": {"path": "uncommitted/cache/weather_df.csv"}},
                "outputs": [{"highs": {"csv": "uncommitted/output.csv"}}],
            },
        }
    }
