...
- Create config maps in your k8s cluster containing values for the following environment variables:
  (TODO this diff Provide more specific kubectl commands here)
...
dagster-user-deployments:
  ...
  deployments:
    - name: "hacker-news-example"
      ...
      port: 3030
      envConfigMaps:
        - name: your-aws-config-map
        - name: your-snowflake-config-map
        - name: your-slack-config-map
