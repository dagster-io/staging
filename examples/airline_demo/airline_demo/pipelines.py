...
class ParquetObjectManager(ObjectManager):
...
@object_manager(
    config_schema={"base_dir": Field(Noneable(str), is_required=False, default_value=None)}
)
def local_parquet_object_manager(init_context):
    return ParquetObjectManager(base_dir=init_context.resource_config["base_dir"])
...
test_mode = ModeDefinition(
    ...
    resource_defs={
        ...
        "pyspark_object_manager": local_parquet_object_manager,
    },
