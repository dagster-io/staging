...
@solid(
    ...
    input_defs=[
        InputDefinition(
            name="data_frame", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        )
    ],
    output_defs=[OutputDefinition(DataFrame, manager_key="pyspark_io_manager")],
)
...
@solid(
    ...
    input_defs=[
        InputDefinition(
            name="sfo_weather_data", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        )
    ],
    output_defs=[OutputDefinition(DataFrame, manager_key="pyspark_io_manager")],
)
...
@solid(
    ...
    input_defs=[
        InputDefinition(
            name="april_data", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        ),
        InputDefinition(
            name="may_data", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        ),
        InputDefinition(
            name="june_data", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        ),
        InputDefinition(
            name="master_cord_data", dagster_type=DataFrame, root_manager_key="pyspark_io_manager"
        ),
    ],
    output_defs=[OutputDefinition(DataFrame, manager_key="pyspark_io_manager")],
)
