...
from airline_demo.pipelines import local_parquet_object_manager
...
def test_airline_demo_load_df():
    ...
    @solid(
        ...
        output_defs=[OutputDefinition(manager_key="pyspark_object_manager")],
    )
        ...
        solid_result = execute_pipeline(
            ...
            run_config={
                ...
                "resources": {
                    ...
                    "pyspark_object_manager": {"config": {"base_dir": temp_dir}},
                },
            },
