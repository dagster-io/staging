...
from dagster.core.execution.context.input import (
    PIPELINE_NAME_PLACEHOLDER,
    InputContext,
    build_input_context,
)
from dagster.core.execution.context.output import (
    RUN_ID_PLACEHOLDER,
    OutputContext,
...
def test_basic_build_input_context():
    ...
    assert context.pipeline_name == PIPELINE_NAME_PLACEHOLDER
...
def test_basic_build_output_context():
    ...
    assert context.run_id == RUN_ID_PLACEHOLDER
