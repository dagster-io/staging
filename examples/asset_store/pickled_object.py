...
if __name__ == "__main__":
    ...
    # result = execute_pipeline(model_pipeline, mode="local")
    # # doesn't work because of missing config
    # result = execute_pipeline(model_pipeline, mode="local", solid_selection=["train_model"])
