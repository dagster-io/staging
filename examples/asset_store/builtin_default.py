...
from dagster.core.storage.asset_store import filesystem_asset_store
...
local_asset_store = filesystem_asset_store.configured({"base_dir": "uncommitted/intermediates/"})
...
@pipeline(
    mode_defs=[
        ModeDefinition("test", resource_defs={"fs_asset_store": filesystem_asset_store}),
