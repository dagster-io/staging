...
from dagster import AssetMaterialization, EventMetadataEntry, InputDefinition, Output, solid
...
@solid
def materialize_dbt_results(context, run_results: DbtCliOutput) -> bool:
