...
We have deprecated "intermediate storage". We have built a new feature called "object manager",
which serve the same purpose as intermediate storage but offers you better control over how inputs
are loaded and output are handled.
