...
If you want to stop execution of a pipeline that's currently running, use the `terminatePipelineExecution` mutation. The only required argument for this mutation is the ID of the run.
