...
However, this level of flexibility is not always necessary - for example, when submitting a new pipeline run, you may only want to think about the pipeline name and configuration and to think less about maintaining a long GraphQL query.
