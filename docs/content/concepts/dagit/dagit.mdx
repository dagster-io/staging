...
<Image alt="Dagit Pipeline Definition" src="/images/concepts/dagit/pipeline-definition.png" width={3808} height={2414} />

### Solid Definition

On the Definition tab, clicking a solid, you can find detailed information about the solid definition.

<Image alt="Dagit Solid Definition" src="/images/concepts/dagit/solid-definition.png" width={3808} height={2414} />
...
<Image alt="Dagit Playground" src="/images/concepts/dagit/playground.png" width={3808} height={2414} />

### Runs Tab

The Runs tab shows the list of recent runs for the pipeline.

<Image alt="Dagit Pipeline Runs Tab" src="/images/concepts/dagit/runs-tab.png" width={3808} height={2414} />
...
<Image alt="Dagit Runs Page" src="/images/concepts/dagit/all-runs.png" width={3808} height={2414} />
...
<Image alt="Dagit Pipeline Run" src="/images/concepts/dagit/single-run.png" width={3808} height={2414} />
...
<Image alt="Dagit Re-execution" src="/images/concepts/dagit/re-execution.png" width={3808} height={2414} />
...
<Image alt="Dagit Asset Catalog" src="/images/concepts/dagit/all-assets.png" width={3808} height={2414} />

### Asset Details

The Asset page lists details about a single asset.

<Image alt="Dagit Asset Details" src="/images/concepts/dagit/asset.png" width={3808} height={2414} />
...
<Image alt="Dagit Schedules" src="/images/concepts/dagit/schedules.png" width={3808} height={2414} />
...
<Image alt="Dagit Sensors" src="/images/concepts/dagit/sensors.png" width={3808} height={2414} />
