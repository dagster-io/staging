...
<Image alt="cli" src="/images/concepts/logging/cli.png" width={1280} height={582} />
...
<Image alt="log-dagit" src="/images/concepts/logging/log-dagit.png" width={4032} height={2454} />

Dagit exposes a powerful facility for filtering log messages based on execution steps and log levels.

<Image alt="log-dagit-filter" src="/images/concepts/logging/log-dagit-filter.png" width={4032} height={2454} />
...
<Image alt="log-dagit-error" src="/images/concepts/logging/log-dagit-error.png" width={4032} height={2454} />
...
<Image alt="custom-logger" src="/images/concepts/logging/custom-logger.png" width={1280} height={330} />
