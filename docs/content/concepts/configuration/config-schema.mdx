...
If you want multiple solids to share a configuration, You can use <PyObject module="dagster" object="make_config_resource" /> to pass the configuration via a resource and reference that resource from any solid that wants to use it.
