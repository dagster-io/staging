...
Solids are linked together by defining the dependencies between their inputs and outputs. Defining dependencies is usually done at the [Pipeline](/concepts/solids-pipelines/pipeline) level.
