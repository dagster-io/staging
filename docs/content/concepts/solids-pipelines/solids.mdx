...
The first parameter of a solids `compute_fn` is the context object, which is an instance of <PyObject object="UserCodeComputeExecutionContext"/>. The context provides access to:
