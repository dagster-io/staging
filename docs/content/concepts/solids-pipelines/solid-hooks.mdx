...
In many cases, you would want to know details about a solid failure. You can get the exception object thrown in the failed solid via the `solid_exception` property on <PyObject module="dagster" object="HookContext" />:
