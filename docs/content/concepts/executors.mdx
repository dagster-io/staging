...
description: Executors are responsible for executing steps within a pipeline run.
---
...
| Name | Description |
| - | - |
| <PyObject object="executor" decorator /> | The decorator used to define executors. |
