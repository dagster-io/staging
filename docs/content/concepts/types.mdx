...
You should not use manually-defined <PyObject module="dagster" object="DagsterType" />
objects in your python type annotations. The simple rule of thumb is to annotate solid bodies just as you would a
regular function, and if you wish to use a <PyObject module="dagster" object="DagsterType" /> alongside
your annotations, you should include this information in the
relevant <PyObject module="dagster" object="InputDefinition" /> or <PyObject module="dagster" object="OutputDefinition" />.
