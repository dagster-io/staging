...
<Image alt="All Sensors" src="/images/concepts/partitions-schedules-sensors/sensors/all-sensors.png" width={1982} height={1400} />

If you click on any sensor, you can monitor all sensor evaluations and runs created:

<Image alt="Sensor A" src="/images/concepts/partitions-schedules-sensors/sensors/sensor-A.png" width={1982} height={1400} />
...
<Image alt="My Directory Sensor" src="/images/concepts/partitions-schedules-sensors/sensors/my-directory-sensor.png" width={1938} height={1356} />
