...
<PyObject module="dagster" object="evaluate_sensor" /> allows for evaluation of the sensor body, resolving
to a list of <PyObject module="dagster" object="RunRequest" /> or <PyObject
  module="dagster"
  object="SkipReason"
/>
s.
...
There is also a CLI command `dagster sensor preview` that evaluates a sensor in a specific repository.
