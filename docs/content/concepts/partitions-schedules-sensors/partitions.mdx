...
Once you have created your partition selector, you can manually create a schedule using the method on your <PyObject object="PartitionSetDefinition" method="create_schedule_definition" />.
