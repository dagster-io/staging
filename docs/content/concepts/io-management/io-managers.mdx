...
| Name                                                                        | Description                                          |
| --------------------------------------------------------------------------- | ---------------------------------------------------- |
| <PyObject module="dagster" object="io_manager" displayText="@io_manager" /> | A decorator used to define IO managers.              |
...
live in between? <PyObject module="dagster" object="IOManager" />s let the user decide.
...
Not all inputs come from upstream outputs. The [Unconnected Inputs](/concepts/io-management/unconnected-inputs) overview
covers <PyObject module="dagster" object="DagsterTypeLoader" />s and <PyObject module="dagster" object="RootInputManager" />s (experimental), which let you decide how
