...
You can find more examples under the [dbt_examples directory](https://github.com/dagster-io/dagster/tree/master/examples/dbt_example) in the dagster repo on GitHub.
