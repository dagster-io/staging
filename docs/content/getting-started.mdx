...
<Image alt="dagit-def" src="/images/getting-started/dagit-def.png" width={4032} height={2454} />
...
<Image alt="dagit-run" src="/images/getting-started/dagit-run.png" width={4032} height={2454} />
...
<p align="center">
  <a href="https://dagster-slackin.herokuapp.com/" target="_blank">
    <img src="/assets/join-us-on-slack.png" width="160" height="40" />
  </a>
</p>
