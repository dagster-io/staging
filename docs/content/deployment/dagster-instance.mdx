...
```yaml file=/deploying/dagster_instance/run_storage/sqlite/dagster.yaml
...
```yaml file=/deploying/dagster_instance/run_storage/postgres/dagster.yaml
...
```yaml file=/deploying/dagster_instance/run_storage/mysql/dagster.yaml
...
In other words, the storage is *run-sharded*. This means that certain useful features, like the Assets page,
...
```yaml file=/deploying/dagster_instance/event_log_storage/sqlite/dagster.yaml
...
as it is not *run sharded*. That is, all runs are persisted to the same Sqlite DB, which allows for cross-run
queries (& thus use of certain Dagster features, like the Assets page).

```yaml file=/deploying/dagster_instance/event_log_storage/consolidated_sqlite/dagster.yaml
...
```yaml file=/deploying/dagster_instance/event_log_storage/postgres/dagster.yaml
...
```yaml file=/deploying/dagster_instance/event_log_storage/mysql/dagster.yaml
...
There are *three* options for the Scheduler: <PyObject module="dagster.core.scheduler" object="DagsterDaemonScheduler" />, <PyObject module="dagster_cron.cron_scheduler" object="SystemCronScheduler" />, and <PyObject module="dagster_k8s" object="K8sScheduler" />.
...
```yaml file=/deploying/dagster_instance/scheduler/dagster_daemon/dagster.yaml
scheduler:
...
```yaml file=/deploying/dagster_instance/schedule_storage/sqlite/dagster.yaml
...
```yaml file=/deploying/dagster_instance/schedule_storage/postgres/dagster.yaml
...
```yaml file=/deploying/dagster_instance/schedule_storage/mysql/dagster.yaml
...
There are *two* Dagster-provided options for the Run Launcher; users also can write custom run launchers.
...
```yaml file=/deploying/dagster_instance/run_launcher/default_run_launcher/dagster.yaml
run_launcher:
...
```yaml file=/deploying/dagster_instance/run_launcher/k8s_run_launcher/dagster.yaml
run_launcher:
...
```yaml file=/deploying/dagster_instance/run_coordinator/queued_run_coordinator/dagster.yaml
...
```yaml file=/deploying/dagster_instance/compute_log_storage/local/dagster.yaml
compute_logs:
...
```yaml file=/deploying/dagster_instance/compute_log_storage/azure_blob/dagster.yaml
compute_logs:
...
```yaml file=/deploying/dagster_instance/compute_log_storage/s3/dagster.yaml
compute_logs:
...
```yaml file=/deploying/dagster_instance/local_artifact_storage/dagster.yaml
...
```yaml file=/deploying/dagster_instance/telemetry/dagster.yaml
