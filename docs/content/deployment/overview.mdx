...
| Item                                                                           | Description                                                                                                                                    |
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [Dagster Instance](http://localhost:3001/deployment/dagster-instance)          | The Dagster Instance holds all of the system configuration for a deployment- where to store metadata about runs, how to launch runs, and more. |
| [Workspace](http://localhost:3001/concepts/repositories-workspaces/workspaces) | The Workspace defines the User Repositories that Dagit loads user code from.                                                                   |
