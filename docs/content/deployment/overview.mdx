...
Dagster requires three long-running services. For simple deployments, you can just run Dagit, and it will manage the Dagster Daemon and User Repository Deployment services for you. For larger deployments, these services can be run and managed separately.
