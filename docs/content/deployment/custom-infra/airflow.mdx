...
description:
  Dagster pipelines can be compiled to Airflow DAGs. If you have a large existing
...
the built-in [scheduler and partition system](/tutorial/advanced-tutorial/scheduling) for scheduling
pipelines, and the [Celery-based executor](/deployment/custom-infra/celery) for large-scale deployments.) But
...
```python file=/intro_tutorial/hello_cereal_pipeline.py
"""
...
<Image alt="intro_airflow_one.png" src="/images/deploying/intro_airflow_one.png" width={1272} height={868} />

Kick off a run manually, and you'll be able to use the ordinary views
of the pipeline's progress:

<Image alt="intro_airflow_dag_view.png" src="/images/deploying/intro_airflow_dag_view.png" width={1272} height={868} />

And logs will be available in the Airflow log viewer:

<Image alt="intro_airflow_logs_view.png" src="/images/deploying/intro_airflow_logs_view.png" width={1272} height={868} />
