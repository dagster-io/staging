...
```python file=/deploying/airflow/pipeline.py
from dagster.core.storage.fs_io_manager import fs_io_manager
import requests
import csv
from dagster import pipeline, solid, ModeDefinition, fs_io_manager
...
dagster-airflow scaffold \
    --module-name docs_snippets.docs_snippets.deploying.airflow.pipeline \
