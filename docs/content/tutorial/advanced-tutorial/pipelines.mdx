...
description: Dagster provides various pipeline-level facilities to avoid hard-coding interactions and therefore improve the development experience.
---
