...
```python file=/intro_tutorial/advanced/configuring_solids/read_csv.py startafter=start_download_csv_marker endbefore=end_download_csv_marker
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/intro_tutorial/advanced/configuring_solids/read_csv.py'
```
