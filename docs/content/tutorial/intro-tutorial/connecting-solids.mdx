...
We've defined our new solid, `sort_by_calories`, to take a user-defined input, `cereals`, in addition to the system-provided <PyObject module="dagster" object="SystemComputeExecutionContext"
