...
The replacement for :py:class:`composite_solid` / :py:class:`CompositeSolidDefinition`, has a more intuitive name and removes the divergence between graphs used for composition and the top level graph structure.
