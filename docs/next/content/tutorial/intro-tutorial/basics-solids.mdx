...
```python file=/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py lines=10-20
@solid
...
```python file=/intro_tutorial/basics/e02_solids/inputs.py lines=8-15
@solid
...
```python file=/intro_tutorial/basics/e02_solids/inputs.py startafter=start_inputs_marker_0 endbefore=end_inputs_marker_0
import csv
import os
...
```python file=/intro_tutorial/basics/e02_solids/inputs.py startafter=start_inputs_marker_1 endbefore=end_inputs_marker_1
...
```python file=/intro_tutorial/basics/e02_solids/inputs.py startafter=start_inputs_marker_2 endbefore=end_inputs_marker_2
...
```yaml file=/intro_tutorial/basics/e02_solids/inputs_env.yaml
solids:
  read_csv:
    inputs:
      csv_path:
