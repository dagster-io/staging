...
This is just a wrapper around Dagstermill's <PyObject module="dagstermill" object="dagstermill_solid" /> which tells Dagstermill where to look for the notebooks. We define a new solid by using this function and referencing a notebook file:
