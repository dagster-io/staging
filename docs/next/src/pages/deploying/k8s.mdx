...
The daemon regularly checks the Runs table in PostgreSQL for Pipeline Runs in that are ready to be launched.
...
3.  [same as default] The Daemon regularly checks for all runs that are ready to be executed.
