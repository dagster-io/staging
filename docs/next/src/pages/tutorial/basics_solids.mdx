...
```python literalinclude showLines startLine=8 emphasize-lines=9-16,26  caption=config.py
...
```python literalinclude showLines startLine=43 emphasize-lines=5  caption=config.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e02_solids/config.py
lines:43-67
```
...
```python literalinclude showLines startLine=76  caption=config.py
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e02_solids/config.py
lines:76-81
```
