...
For example, when we execute our pipeline with this config (you can add it to Dagit Playground and launch execution), it'll fail at runtime:
...
![inputs_typed_error_message.png](/assets/images/tutorial/inputs_typed_error_message.png)
