...
```python literalinclude showLines startLine=25 emphasize-lines=25-33 caption=materializations.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/materializations/materializations.py
startAfter:start_materializations_marker_0
endBefore:end_materializations_marker_0
```
...
```python literalinclude showLines startLine=32 caption=output_materialization.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/materializations/output_materialization.py
startAfter:start_output_materialization_marker_0
endBefore:end_output_materialization_marker_0
```

We set the output materialization config on the type:

```python literalinclude showLines startLine=86 emphasize-lines=5 caption=output_materialization.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/materializations/output_materialization.py
startAfter:start_output_materialization_marker_1
endBefore:end_output_materialization_marker_1
```
