...
```python literalinclude showLines startLine=29 caption=scheduler.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/scheduling/scheduler.py
...
```python literalinclude showLines startLine=41 caption=scheduler.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/scheduling/scheduler.py
...
```python literalinclude showLines startLine=58 caption=scheduler.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/scheduling/scheduler.py
