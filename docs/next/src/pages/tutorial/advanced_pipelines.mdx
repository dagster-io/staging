...
```python literalinclude showLines startLine=64 emphasize-lines=18 caption=resources.py
...
```python literalinclude showLines startLine=18 emphasize-lines=28-30 caption=resources.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/resources.py
startAfter:start_resources_marker_0
endBefore:end_resources_marker_0
```
...
```python literalinclude showLines startLine=93 emphasize-lines=1 caption=resources.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/resources.py
startAfter: start_resources_marker_2
endBefore: end_resources_marker_2
```
...
```python literalinclude showLines startLine=58 emphasize-lines=1 caption=required_resources.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/required_resources.py
startAfter:start_required_resources_marker_0
endBefore:end_required_resources_marker_0
```
...
```python literalinclude showLines startLine=78 caption=modes.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/modes.py
startAfter:start_modes_marker_0
endBefore:end_modes_marker_0
```
...
```python literalinclude showLines startLine=135 caption=modes.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/modes.py
startAfter:start_modes_marker_1
endBefore:end_modes_marker_1
```
...
```python literalinclude showLines startLine=154 emphasize-lines=5 caption=modes.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/modes.py
startAfter:start_modes_main
endBefore:end_modes_main
dedent:4
```
...
```python literalinclude showLines startLine=170 caption=presets.py
file:/docs_snippets/docs_snippets/intro_tutorial/advanced/pipelines/presets.py
startAfter:start_presets_main
endBefore:end_presets_main
dedent:4
```
