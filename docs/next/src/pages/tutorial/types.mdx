...
![custom_types_figure_one_SimpleDataFrame.png](/assets/images/tutorial/custom_types_figure_one_SimpleDataFrame.png)
...
Before we run the pipeline, don't forget to add the config:

![custom_types_2_yaml.png](/assets/images/tutorial/custom_types_2_yaml.png)

When we run the pipeline with this solid, we'll see an error in your terminal like:

```bash
2020-10-01 17:20:54 - dagster - ERROR - custom_type_pipeline - c3267e86-10e9-472d-80e9-15a61d2b6360 - 8649 - bad_read_csv.compute - STEP_FAILURE - Execution of step "bad_read_csv.compute" failed.
...
(Remember to provide the config):
