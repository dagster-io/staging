...
startAfter:start_solid_marker
endBefore:end_solid_marker
```
...
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py
startAfter:start_pipeline_marker
endBefore:end_pipeline_marker
```
...
file:/docs_snippets/docs_snippets/intro_tutorial/basics/e01_first_pipeline/hello_cereal.py
startAfter:start_execute_marker
endBefore:end_execute_marker
```
