...
We would love to see community members get as involved as you want to be.
...
We encourage you to start with the issues labeled with the tag
...
When you are ready for more challenge, you can solve the issue with the most 👍.
The use of emoji measure as a proxy for Dasgter user interests.

## Submit your code

To submit your code, fork the Dasgter repository (https://help.github.com/en/articles/fork-a-repo),
...
You will use a PR template to describe your codes, including the motivation and the context, the tests to cover your change,
and any other relevant information. Make sure you tell us if the PR is a breaking changes, fixing a bug, adding a new feature
...
Once approved and all the tests (including BK) pass, the reviewer will click Squash and merge in Github 🥳.

Your PR is now merged into Dasgter! We’ll shout out for your contribution in the weekly release notes.
You’ll receive a gift code in the future to get a free swag once our Dagster Swag Store is online!
