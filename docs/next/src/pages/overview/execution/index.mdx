...
Dagster includes Python APIs for execution that are useful when writing tests or scripts. <PyObject module="dagster" object="execute_pipeline" /> allows for execution of a full pipeline, and returns a <PyObject module="dagster" object="PipelineExecutionResult" />.
...
We also provide <PyObject module="dagster" object="execute_solid" /> for executing an individual solid. Under the hood this constructs an ephemeral pipeline containing only this solid.
