...
We also provide python APIs for execution that are useful when writing tests or scripts. <PyObject module="dagster" object="execute_pipeline" /> for full full pipeline execution and
...
We also provide <PyObject module="dagster" object="execute_solid" /> for executing an individual solid.
