...
Dagster enables sensors capable of instigating runs based on some external state change. To create a sensor, define a <PyObject module="dagster" object="SensorDefinition"/> and include it in your repository.
