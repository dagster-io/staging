...
In practice, the frequency that any particular sensor will be evaluated equals the minimum multiple
of the daemon interval that is larger than or equal to the individual sensor's minimum interval.
