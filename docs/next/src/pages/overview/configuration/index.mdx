...
The `configured` API offers a way to do this.  When invoked on a <PyObject module="dagster" object="ResourceDefinition" />,
<PyObject module="dagster" object="ExecutorDefinition" />, <PyObject module="dagster" object="CompositeSolidDefinition" />,
<PyObject module="dagster" object="SolidDefinition" />, <PyObject module="dagster" object="LoggerDefinition" />,
<PyObject module="dagster" object="IntermediateStorageDefinition" />, or <PyObject module="dagster" object="SystemStorageDefinition" />,
