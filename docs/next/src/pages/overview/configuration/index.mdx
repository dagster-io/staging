...
complex configuration. One notable example is <PyObject module="dagster" object="Selector" /> which is used
extensively within dagster to choose an option from a well defined set and provide additional configuration for it.

You can see the full list of supported types in the <PyObject module="dagster" object="ConfigSchema" /> API docs.
