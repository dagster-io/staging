...
To run the `dagster-daemon` process locally, run the following command on the same
...
- The _scheduler daemon_ is responsible for creating runs rom any [schedules](/overview/schedules-sensors/schedules) that
