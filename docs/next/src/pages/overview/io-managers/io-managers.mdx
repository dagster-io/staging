...
<PyObject module="dagster" object="IOManager" /> is an interface that inherits from both the <PyObject module="dagster" object="RootInputManager" /> and <PyObject module="dagster" object="OutputManager" /> interfaces:

<p/>

<p align="center">
  <img src="/assets/images/overview/io-managers/manager-venn-diagram.png" width="600px"/>
</p>
...
To select the IOManager for a particular output, you can set an `manager_key` on the <PyObject module="dagster" object="OutputDefinition" />, and then refer to that `manager_key` when setting IO managers in your <PyObject module="dagster" object="ModeDefinition" />.  In this example, the output of solid1 will go to `fs_io_manager` and the output of solid2 will go to `mem_io_manager`.
