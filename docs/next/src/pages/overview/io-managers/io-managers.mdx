...
<PyObject module="dagster" object="IOManager" />s let users decide how solid outputs are stored and loaded in downstream solids.

<PyObject module="dagster" object="DagsterTypeLoader" />s and <PyObject module="dagster" object="RootInputManager" />s (experimental) let users decide how inputs at the beginning of a pipeline are loaded.
...
```python literalinclude caption=load_from_config.py
file:/docs_snippets/docs_snippets/overview/io_managers/load_from_config.py
...
```python literalinclude caption=load_custom_type_from_config.py
file:/docs_snippets/docs_snippets/overview/io_managers/load_custom_type_from_config.py
startAfter:def_start_marker
endBefore:def_end_marker
```
