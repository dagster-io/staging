...
<PyObject module="dagster" object="IOManager" /> is an interface that inherits from both the <PyObject module="dagster" object="InputManager" /> and <PyObject module="dagster" object="OutputManager" /> interfaces:
