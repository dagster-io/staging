...
`python -m dagster.grpc` and pass it a target file or module to load.
...
python -m dagster.grpc --python-file /path/to/file.py --host 0.0.0.0 --port 4266
python -m dagster.grpc --python-file /path/to/file.py --host 0.0.0.0 --port /path/to/socket

# Load gRPC Server using python package:
python -m dagster.grpc --package-name my_package_name --host 0.0.0.0 --port 4266
python -m dagster.grpc --package-name my_package_name --host 0.0.0.0 --socket /path/to/socket

# Specify an attribute within the target to load a specific repository:
python -m dagster.grpc --python-file /path/to/file.py --attribute my_repository --host 0.0.0.0 --port 4266
python -m dagster.grpc --package-name my_package_name --attribute my_repository --host 0.0.0.0 --port 4266
```
