...
- [Data Science with Notebooks](#data-science-with-notebooks)
...
We can simply turn a notebook into a solid using <PyObject module="dagstermill" object="dagstermill_solid" />.
